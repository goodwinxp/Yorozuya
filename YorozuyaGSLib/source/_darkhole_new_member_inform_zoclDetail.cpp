#include <_darkhole_new_member_inform_zoclDetail.hpp>
...
START_ATF_NAMESPACE
    namespace Detail
    {
        ...
        ::std::array<hook_record, 1> _darkhole_new_member_inform_zocl_functions = 
        {
            _hook_record {
                (LPVOID)0x14026f4c0L,
                (LPVOID *)&_darkhole_new_member_inform_zoclsize2_user,
                (LPVOID *)&_darkhole_new_member_inform_zoclsize2_next,
                (LPVOID)cast_pointer_function(_darkhole_new_member_inform_zoclsize2_wrapper),
                (LPVOID)cast_pointer_function((int(_darkhole_new_member_inform_zocl::*)())&_darkhole_new_member_inform_zocl::size)
            },
        };
