...
namespace GameServer
{
    namespace Fixes
    {
        ...
        Yorozuya::Module::ModuleName_t CAttackSystem::get_name()
        {
            static const Yorozuya::Module::ModuleName_t name = "fix.attack_system";
            return name;
        }
            ...
            ATF::Info::CPlayer_pre_check_force_attack1364_ptr next)
        {
            ...
            do
            {
                ...
                PlayerEx.SetForceAttackDelay(
                    ...
                    ::std::chrono::milliseconds((int)pForceFld->m_fActDelay + nAddDelay));
            } while (false);
            ...
            ATF::Info::CPlayer_pre_check_normal_attack1370_ptr next)
        {
            ...
            do
            {
                ...
                PlayerEx.SetNormalAttackDelay(::std::chrono::milliseconds(nDelay));
            } while (false);
            ...
            ATF::Info::CPlayer_pre_check_siege_attack1372_ptr next)
        {
            ...
            do
            {
                ...
                PlayerEx.SetSiegeAttackDelay(::std::chrono::milliseconds(nDelay));
            } while (false);
            ...
            ATF::Info::CPlayer_pre_check_unit_attack1380_ptr next)
        {
            ...
            do
            {
                ...
                PlayerEx.SetUnitAttackDelay(::std::chrono::milliseconds(pWeaponFld->m_nAttackDel));
            } while (false);
            ...
            ATF::Info::CPlayerpc_ThrowUnitRequest1955_ptr next)
        {
            ...
            do
            {
                ...
                PlayerEx.SetUnitAttackDelay(::std::chrono::milliseconds(pPartFld->m_nAttackDel));
