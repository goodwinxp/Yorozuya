...
namespace GameServer
{
    namespace Fixes
    {
        ...
        Yorozuya::Module::ModuleName_t CStore::get_name()
        {
            static const Yorozuya::Module::ModuleName_t name = "fix.store";
            return name;
        }
        ...
        {
            ::std::array<uint64_t, (size_t)e_money_type::num> uuSummaryPrice{0};
