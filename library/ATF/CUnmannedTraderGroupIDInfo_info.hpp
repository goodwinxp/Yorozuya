...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CUnmannedTraderGroupIDInfoGetIDInfo10_ptr = bool (WINAPIV*)(struct CUnmannedTraderGroupIDInfo*, struct std::vector<std::pair<unsigned long,unsigned long>,std::allocator<std::pair<unsigned long,unsigned long> > >*);
        using CUnmannedTraderGroupIDInfoGetIDInfo10_clbk = bool (WINAPIV*)(struct CUnmannedTraderGroupIDInfo*, struct std::vector<std::pair<unsigned long,unsigned long>,std::allocator<std::pair<unsigned long,unsigned long> > >*, CUnmannedTraderGroupIDInfoGetIDInfo10_ptr);
