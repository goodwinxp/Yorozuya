...
START_ATF_NAMESPACE
    namespace detail
    {
        ...
        {   (LPVOID)0x1400781a0L,
            (LPVOID *)&_TOWER_PARAM___listinit2_user,
            (LPVOID *)&_TOWER_PARAM___listinit2_next,
            (LPVOID)cast_pointer_function(_TOWER_PARAM___listinit2_wrapper),
            (LPVOID)cast_pointer_function((void(_TOWER_PARAM::_list::*)())&_TOWER_PARAM::_list::init) },
