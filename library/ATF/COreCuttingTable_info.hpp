...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using COreCuttingTable___ore_cut_listctor__ore_cut_list2_ptr = void (WINAPIV*)(struct COreCuttingTable::_ore_cut_list*);
        using COreCuttingTable___ore_cut_listctor__ore_cut_list2_clbk = void (WINAPIV*)(struct COreCuttingTable::_ore_cut_list*, COreCuttingTable___ore_cut_listctor__ore_cut_list2_ptr);
