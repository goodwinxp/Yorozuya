...
START_ATF_NAMESPACE
    namespace detail
    {
        ...
        info::_CUTTING_DB_BASE___LISTInit2_ptr _CUTTING_DB_BASE___LISTInit2_next(nullptr);
        info::_CUTTING_DB_BASE___LISTInit2_clbk _CUTTING_DB_BASE___LISTInit2_user(nullptr);
        info::_CUTTING_DB_BASE___LISTctor__LIST4_ptr _CUTTING_DB_BASE___LISTctor__LIST4_next(nullptr);
        info::_CUTTING_DB_BASE___LISTctor__LIST4_clbk _CUTTING_DB_BASE___LISTctor__LIST4_user(nullptr);
        ...
        void _CUTTING_DB_BASE___LISTInit2_wrapper(struct _CUTTING_DB_BASE::_LIST* _this)
        {
           _CUTTING_DB_BASE___LISTInit2_user(_this, _CUTTING_DB_BASE___LISTInit2_next);
        };
        void _CUTTING_DB_BASE___LISTctor__LIST4_wrapper(struct _CUTTING_DB_BASE::_LIST* _this)
        {
           _CUTTING_DB_BASE___LISTctor__LIST4_user(_this, _CUTTING_DB_BASE___LISTctor__LIST4_next);
        };
        
        hook_record _CUTTING_DB_BASE_functions[] = {
        {   (LPVOID)0x140076780L,
