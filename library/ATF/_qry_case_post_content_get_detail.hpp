...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_qry_case_post_content_getctor__qry_case_post_content_get2_ptr _qry_case_post_content_getctor__qry_case_post_content_get2_next(nullptr);
        static info::_qry_case_post_content_getctor__qry_case_post_content_get2_clbk _qry_case_post_content_getctor__qry_case_post_content_get2_user(nullptr);
        static info::_qry_case_post_content_getsize4_ptr _qry_case_post_content_getsize4_next(nullptr);
        static info::_qry_case_post_content_getsize4_clbk _qry_case_post_content_getsize4_user(nullptr);
        
        static void _qry_case_post_content_getctor__qry_case_post_content_get2_wrapper(struct _qry_case_post_content_get* _this)
        {
        ...
        static int _qry_case_post_content_getsize4_wrapper(struct _qry_case_post_content_get* _this)
        {
           return _qry_case_post_content_getsize4_user(_this, _qry_case_post_content_getsize4_next);
        };
        
        static hook_record _qry_case_post_content_get_functions[] = {
        {   (LPVOID)0x1400ca730L,
