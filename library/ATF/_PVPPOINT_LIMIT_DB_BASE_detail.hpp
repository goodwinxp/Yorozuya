...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_PVPPOINT_LIMIT_DB_BASEInit2_ptr _PVPPOINT_LIMIT_DB_BASEInit2_next(nullptr);
        static info::_PVPPOINT_LIMIT_DB_BASEInit2_clbk _PVPPOINT_LIMIT_DB_BASEInit2_user(nullptr);
        static info::_PVPPOINT_LIMIT_DB_BASEctor__PVPPOINT_LIMIT_DB_BASE4_ptr _PVPPOINT_LIMIT_DB_BASEctor__PVPPOINT_LIMIT_DB_BASE4_next(nullptr);
        static info::_PVPPOINT_LIMIT_DB_BASEctor__PVPPOINT_LIMIT_DB_BASE4_clbk _PVPPOINT_LIMIT_DB_BASEctor__PVPPOINT_LIMIT_DB_BASE4_user(nullptr);
        static info::_PVPPOINT_LIMIT_DB_BASEdtor__PVPPOINT_LIMIT_DB_BASE6_ptr _PVPPOINT_LIMIT_DB_BASEdtor__PVPPOINT_LIMIT_DB_BASE6_next(nullptr);
        static info::_PVPPOINT_LIMIT_DB_BASEdtor__PVPPOINT_LIMIT_DB_BASE6_clbk _PVPPOINT_LIMIT_DB_BASEdtor__PVPPOINT_LIMIT_DB_BASE6_user(nullptr);
        
        static void _PVPPOINT_LIMIT_DB_BASEInit2_wrapper(struct _PVPPOINT_LIMIT_DB_BASE* _this)
        {
           _PVPPOINT_LIMIT_DB_BASEInit2_user(_this, _PVPPOINT_LIMIT_DB_BASEInit2_next);
        };
        static void _PVPPOINT_LIMIT_DB_BASEctor__PVPPOINT_LIMIT_DB_BASE4_wrapper(struct _PVPPOINT_LIMIT_DB_BASE* _this)
        {
        ...
        static void _PVPPOINT_LIMIT_DB_BASEdtor__PVPPOINT_LIMIT_DB_BASE6_wrapper(struct _PVPPOINT_LIMIT_DB_BASE* _this)
        {
        ...
        static hook_record _PVPPOINT_LIMIT_DB_BASE_functions[] = {
        {   (LPVOID)0x140077ce0L,
