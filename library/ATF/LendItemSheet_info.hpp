...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using LendItemSheet__Cellctor_Cell2_ptr = void (WINAPIV*)(struct LendItemSheet::Cell*, char, struct _STORAGE_LIST::_db_con*);
        using LendItemSheet__Cellctor_Cell2_clbk = void (WINAPIV*)(struct LendItemSheet::Cell*, char, struct _STORAGE_LIST::_db_con*, LendItemSheet__Cellctor_Cell2_ptr);
        using LendItemSheet__Cellctor_Cell4_ptr = void (WINAPIV*)(struct LendItemSheet::Cell*);
        using LendItemSheet__Cellctor_Cell4_clbk = void (WINAPIV*)(struct LendItemSheet::Cell*, LendItemSheet__Cellctor_Cell4_ptr);
