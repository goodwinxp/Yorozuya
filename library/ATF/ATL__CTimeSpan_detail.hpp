...
#include "ATL__CTimeSpan_info.hpp"
...
START_ATF_NAMESPACE
    namespace ATL
    {
        namespace detail
        {
            static info::ATL__CTimeSpanctor_CTimeSpan1_ptr ATL__CTimeSpanctor_CTimeSpan1_next(nullptr);
            static info::ATL__CTimeSpanctor_CTimeSpan1_clbk ATL__CTimeSpanctor_CTimeSpan1_user(nullptr);
            static info::ATL__CTimeSpanctor_CTimeSpan2_ptr ATL__CTimeSpanctor_CTimeSpan2_next(nullptr);
            static info::ATL__CTimeSpanctor_CTimeSpan2_clbk ATL__CTimeSpanctor_CTimeSpan2_user(nullptr);
            static info::ATL__CTimeSpanctor_CTimeSpan3_ptr ATL__CTimeSpanctor_CTimeSpan3_next(nullptr);
            static info::ATL__CTimeSpanctor_CTimeSpan3_clbk ATL__CTimeSpanctor_CTimeSpan3_user(nullptr);
            static info::ATL__CTimeSpanGetDays4_ptr ATL__CTimeSpanGetDays4_next(nullptr);
            static info::ATL__CTimeSpanGetDays4_clbk ATL__CTimeSpanGetDays4_user(nullptr);
            static info::ATL__CTimeSpanGetHours5_ptr ATL__CTimeSpanGetHours5_next(nullptr);
            static info::ATL__CTimeSpanGetHours5_clbk ATL__CTimeSpanGetHours5_user(nullptr);
            static info::ATL__CTimeSpanGetMinutes6_ptr ATL__CTimeSpanGetMinutes6_next(nullptr);
            static info::ATL__CTimeSpanGetMinutes6_clbk ATL__CTimeSpanGetMinutes6_user(nullptr);
            static info::ATL__CTimeSpanGetSeconds7_ptr ATL__CTimeSpanGetSeconds7_next(nullptr);
            static info::ATL__CTimeSpanGetSeconds7_clbk ATL__CTimeSpanGetSeconds7_user(nullptr);
            static info::ATL__CTimeSpanGetTimeSpan8_ptr ATL__CTimeSpanGetTimeSpan8_next(nullptr);
            static info::ATL__CTimeSpanGetTimeSpan8_clbk ATL__CTimeSpanGetTimeSpan8_user(nullptr);
            static info::ATL__CTimeSpanGetTotalHours9_ptr ATL__CTimeSpanGetTotalHours9_next(nullptr);
            static info::ATL__CTimeSpanGetTotalHours9_clbk ATL__CTimeSpanGetTotalHours9_user(nullptr);
            static info::ATL__CTimeSpanGetTotalMinutes10_ptr ATL__CTimeSpanGetTotalMinutes10_next(nullptr);
            static info::ATL__CTimeSpanGetTotalMinutes10_clbk ATL__CTimeSpanGetTotalMinutes10_user(nullptr);
            static info::ATL__CTimeSpanGetTotalSeconds11_ptr ATL__CTimeSpanGetTotalSeconds11_next(nullptr);
            static info::ATL__CTimeSpanGetTotalSeconds11_clbk ATL__CTimeSpanGetTotalSeconds11_user(nullptr);
            
            static void ATL__CTimeSpanctor_CTimeSpan1_wrapper(struct ATL::CTimeSpan* _this, int64_t time)
            {
               ATL__CTimeSpanctor_CTimeSpan1_user(_this, time, ATL__CTimeSpanctor_CTimeSpan1_next);
            };
            static void ATL__CTimeSpanctor_CTimeSpan2_wrapper(struct ATL::CTimeSpan* _this, int lDays, int nHours, int nMins, int nSecs)
            {
               ATL__CTimeSpanctor_CTimeSpan2_user(_this, lDays, nHours, nMins, nSecs, ATL__CTimeSpanctor_CTimeSpan2_next);
            };
            static void ATL__CTimeSpanctor_CTimeSpan3_wrapper(struct ATL::CTimeSpan* _this)
            {
               ATL__CTimeSpanctor_CTimeSpan3_user(_this, ATL__CTimeSpanctor_CTimeSpan3_next);
            };
            static int64_t ATL__CTimeSpanGetDays4_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetDays4_user(_this, ATL__CTimeSpanGetDays4_next);
            };
            static int ATL__CTimeSpanGetHours5_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetHours5_user(_this, ATL__CTimeSpanGetHours5_next);
            };
            static int ATL__CTimeSpanGetMinutes6_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetMinutes6_user(_this, ATL__CTimeSpanGetMinutes6_next);
            };
            static int ATL__CTimeSpanGetSeconds7_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetSeconds7_user(_this, ATL__CTimeSpanGetSeconds7_next);
            };
            static int64_t ATL__CTimeSpanGetTimeSpan8_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetTimeSpan8_user(_this, ATL__CTimeSpanGetTimeSpan8_next);
            };
            static int64_t ATL__CTimeSpanGetTotalHours9_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetTotalHours9_user(_this, ATL__CTimeSpanGetTotalHours9_next);
            };
            static int64_t ATL__CTimeSpanGetTotalMinutes10_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetTotalMinutes10_user(_this, ATL__CTimeSpanGetTotalMinutes10_next);
            };
            static int64_t ATL__CTimeSpanGetTotalSeconds11_wrapper(struct ATL::CTimeSpan* _this)
            {
               return ATL__CTimeSpanGetTotalSeconds11_user(_this, ATL__CTimeSpanGetTotalSeconds11_next);
            };
            
            static hook_record CTimeSpan_functions[] = {
            {   (LPVOID)0x140672200L,
