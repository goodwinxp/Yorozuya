...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_qry_case_update_data_for_tradector__qry_case_update_data_for_trade2_ptr _qry_case_update_data_for_tradector__qry_case_update_data_for_trade2_next(nullptr);
        static info::_qry_case_update_data_for_tradector__qry_case_update_data_for_trade2_clbk _qry_case_update_data_for_tradector__qry_case_update_data_for_trade2_user(nullptr);
        static info::_qry_case_update_data_for_tradesize4_ptr _qry_case_update_data_for_tradesize4_next(nullptr);
        static info::_qry_case_update_data_for_tradesize4_clbk _qry_case_update_data_for_tradesize4_user(nullptr);
        
        static void _qry_case_update_data_for_tradector__qry_case_update_data_for_trade2_wrapper(struct _qry_case_update_data_for_trade* _this)
        {
        ...
        static int _qry_case_update_data_for_tradesize4_wrapper(struct _qry_case_update_data_for_trade* _this)
        {
           return _qry_case_update_data_for_tradesize4_user(_this, _qry_case_update_data_for_tradesize4_next);
        };
        
        static hook_record _qry_case_update_data_for_trade_functions[] = {
        {   (LPVOID)0x1400f7be0L,
