...
START_ATF_NAMESPACE
    namespace GUILD_BATTLE
    {
        namespace detail
        {
            ...
            struct ATL::CTimeSpan* GUILD_BATTLE__CNormalGuildBattleStateReadyGetTerm6_wrapper(struct GUILD_BATTLE::CNormalGuildBattleStateReady* _this, struct ATL::CTimeSpan* result)
            {
            ...
            hook_record CNormalGuildBattleStateReady_functions[] = {
            {   (LPVOID)0x1403f0770L,
