...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_attack_keeper_inform_zoclctor__attack_keeper_inform_zocl2_ptr _attack_keeper_inform_zoclctor__attack_keeper_inform_zocl2_next(nullptr);
        static info::_attack_keeper_inform_zoclctor__attack_keeper_inform_zocl2_clbk _attack_keeper_inform_zoclctor__attack_keeper_inform_zocl2_user(nullptr);
        static info::_attack_keeper_inform_zoclsize4_ptr _attack_keeper_inform_zoclsize4_next(nullptr);
        static info::_attack_keeper_inform_zoclsize4_clbk _attack_keeper_inform_zoclsize4_user(nullptr);
        
        static void _attack_keeper_inform_zoclctor__attack_keeper_inform_zocl2_wrapper(struct _attack_keeper_inform_zocl* _this)
        {
        ...
        static int _attack_keeper_inform_zoclsize4_wrapper(struct _attack_keeper_inform_zocl* _this)
        {
           return _attack_keeper_inform_zoclsize4_user(_this, _attack_keeper_inform_zoclsize4_next);
        };
        
        static hook_record _attack_keeper_inform_zocl_functions[] = {
        {   (LPVOID)0x140136c00L,
