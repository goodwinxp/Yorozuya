...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CNetIndexList___index_nodector__index_node2_ptr = void (WINAPIV*)(struct CNetIndexList::_index_node*);
        using CNetIndexList___index_nodector__index_node2_clbk = void (WINAPIV*)(struct CNetIndexList::_index_node*, CNetIndexList___index_nodector__index_node2_ptr);
