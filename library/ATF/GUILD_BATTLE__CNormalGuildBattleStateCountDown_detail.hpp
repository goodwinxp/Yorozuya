...
START_ATF_NAMESPACE
    namespace GUILD_BATTLE
    {
        namespace detail
        {
            ...
            struct ATL::CTimeSpan* GUILD_BATTLE__CNormalGuildBattleStateCountDownGetTerm6_wrapper(struct GUILD_BATTLE::CNormalGuildBattleStateCountDown* _this, struct ATL::CTimeSpan* result)
            {
            ...
            hook_record CNormalGuildBattleStateCountDown_functions[] = {
            {   (LPVOID)0x1403f0820L,
