...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using _ITEMCOMBINE_DB_BASE___LISTInit2_ptr = void (WINAPIV*)(struct _ITEMCOMBINE_DB_BASE::_LIST*);
        using _ITEMCOMBINE_DB_BASE___LISTInit2_clbk = void (WINAPIV*)(struct _ITEMCOMBINE_DB_BASE::_LIST*, _ITEMCOMBINE_DB_BASE___LISTInit2_ptr);
        using _ITEMCOMBINE_DB_BASE___LISTctor__LIST4_ptr = void (WINAPIV*)(struct _ITEMCOMBINE_DB_BASE::_LIST*);
        using _ITEMCOMBINE_DB_BASE___LISTctor__LIST4_clbk = void (WINAPIV*)(struct _ITEMCOMBINE_DB_BASE::_LIST*, _ITEMCOMBINE_DB_BASE___LISTctor__LIST4_ptr);
