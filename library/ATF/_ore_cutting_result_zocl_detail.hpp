...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_ore_cutting_result_zoclctor__ore_cutting_result_zocl2_ptr _ore_cutting_result_zoclctor__ore_cutting_result_zocl2_next(nullptr);
        static info::_ore_cutting_result_zoclctor__ore_cutting_result_zocl2_clbk _ore_cutting_result_zoclctor__ore_cutting_result_zocl2_user(nullptr);
        static info::_ore_cutting_result_zoclsize4_ptr _ore_cutting_result_zoclsize4_next(nullptr);
        static info::_ore_cutting_result_zoclsize4_clbk _ore_cutting_result_zoclsize4_user(nullptr);
        
        static void _ore_cutting_result_zoclctor__ore_cutting_result_zocl2_wrapper(struct _ore_cutting_result_zocl* _this)
        {
        ...
        static int _ore_cutting_result_zoclsize4_wrapper(struct _ore_cutting_result_zocl* _this)
        {
           return _ore_cutting_result_zoclsize4_user(_this, _ore_cutting_result_zoclsize4_next);
        };
        
        static hook_record _ore_cutting_result_zocl_functions[] = {
        {   (LPVOID)0x1400efa50L,
