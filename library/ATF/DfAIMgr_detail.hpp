...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::DfAIMgrAction_Attack_OnLoop2_ptr DfAIMgrAction_Attack_OnLoop2_next(nullptr);
        static info::DfAIMgrAction_Attack_OnLoop2_clbk DfAIMgrAction_Attack_OnLoop2_user(nullptr);
        static info::DfAIMgrAction_Change_Handler4_ptr DfAIMgrAction_Change_Handler4_next(nullptr);
        static info::DfAIMgrAction_Change_Handler4_clbk DfAIMgrAction_Change_Handler4_user(nullptr);
        static info::DfAIMgrAction_Patrol_OnLoop6_ptr DfAIMgrAction_Patrol_OnLoop6_next(nullptr);
        static info::DfAIMgrAction_Patrol_OnLoop6_clbk DfAIMgrAction_Patrol_OnLoop6_user(nullptr);
        static info::DfAIMgrAction_Runaway_OnLoop8_ptr DfAIMgrAction_Runaway_OnLoop8_next(nullptr);
        static info::DfAIMgrAction_Runaway_OnLoop8_clbk DfAIMgrAction_Runaway_OnLoop8_user(nullptr);
        static info::DfAIMgrAction_Wait_OnLoop10_ptr DfAIMgrAction_Wait_OnLoop10_next(nullptr);
        static info::DfAIMgrAction_Wait_OnLoop10_clbk DfAIMgrAction_Wait_OnLoop10_user(nullptr);
        static info::DfAIMgrAssist_OnChange12_ptr DfAIMgrAssist_OnChange12_next(nullptr);
        static info::DfAIMgrAssist_OnChange12_clbk DfAIMgrAssist_OnChange12_user(nullptr);
        static info::DfAIMgrAssist_OnLoop14_ptr DfAIMgrAssist_OnLoop14_next(nullptr);
        static info::DfAIMgrAssist_OnLoop14_clbk DfAIMgrAssist_OnLoop14_user(nullptr);
        static info::DfAIMgrAtp_Lost_Handler16_ptr DfAIMgrAtp_Lost_Handler16_next(nullptr);
        static info::DfAIMgrAtp_Lost_Handler16_clbk DfAIMgrAtp_Lost_Handler16_user(nullptr);
        static info::DfAIMgrAtp_SearchStart_OnLoop18_ptr DfAIMgrAtp_SearchStart_OnLoop18_next(nullptr);
        static info::DfAIMgrAtp_SearchStart_OnLoop18_clbk DfAIMgrAtp_SearchStart_OnLoop18_user(nullptr);
        static info::DfAIMgrAtp_Searched_Handler20_ptr DfAIMgrAtp_Searched_Handler20_next(nullptr);
        static info::DfAIMgrAtp_Searched_Handler20_clbk DfAIMgrAtp_Searched_Handler20_user(nullptr);
        static info::DfAIMgrChangeTargetPos22_ptr DfAIMgrChangeTargetPos22_next(nullptr);
        static info::DfAIMgrChangeTargetPos22_clbk DfAIMgrChangeTargetPos22_user(nullptr);
        static info::DfAIMgrCheckAlienation24_ptr DfAIMgrCheckAlienation24_next(nullptr);
        static info::DfAIMgrCheckAlienation24_clbk DfAIMgrCheckAlienation24_user(nullptr);
        static info::DfAIMgrCheckEmotionBad26_ptr DfAIMgrCheckEmotionBad26_next(nullptr);
        static info::DfAIMgrCheckEmotionBad26_clbk DfAIMgrCheckEmotionBad26_user(nullptr);
        static info::DfAIMgrCheckGen28_ptr DfAIMgrCheckGen28_next(nullptr);
        static info::DfAIMgrCheckGen28_clbk DfAIMgrCheckGen28_user(nullptr);
        static info::DfAIMgrCheckMonArea_N_ChangeState30_ptr DfAIMgrCheckMonArea_N_ChangeState30_next(nullptr);
        static info::DfAIMgrCheckMonArea_N_ChangeState30_clbk DfAIMgrCheckMonArea_N_ChangeState30_user(nullptr);
        static info::DfAIMgrCheckSPF32_ptr DfAIMgrCheckSPF32_next(nullptr);
        static info::DfAIMgrCheckSPF32_clbk DfAIMgrCheckSPF32_user(nullptr);
        static info::DfAIMgrCheckSPFDelayTime34_ptr DfAIMgrCheckSPFDelayTime34_next(nullptr);
        static info::DfAIMgrCheckSPFDelayTime34_clbk DfAIMgrCheckSPFDelayTime34_user(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE36_ptr DfAIMgrCheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE36_next(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE36_clbk DfAIMgrCheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE36_user(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_DF38_ptr DfAIMgrCheckSPF_MON_MOTIVE_DF38_next(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_DF38_clbk DfAIMgrCheckSPF_MON_MOTIVE_DF38_user(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_MY_HP_DOWN40_ptr DfAIMgrCheckSPF_MON_MOTIVE_MY_HP_DOWN40_next(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_MY_HP_DOWN40_clbk DfAIMgrCheckSPF_MON_MOTIVE_MY_HP_DOWN40_user(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_OTHER_HP_DOWN42_ptr DfAIMgrCheckSPF_MON_MOTIVE_OTHER_HP_DOWN42_next(nullptr);
        static info::DfAIMgrCheckSPF_MON_MOTIVE_OTHER_HP_DOWN42_clbk DfAIMgrCheckSPF_MON_MOTIVE_OTHER_HP_DOWN42_user(nullptr);
        static info::DfAIMgrCondition_OnChange44_ptr DfAIMgrCondition_OnChange44_next(nullptr);
        static info::DfAIMgrCondition_OnChange44_clbk DfAIMgrCondition_OnChange44_user(nullptr);
        static info::DfAIMgrCondition_OnLoop46_ptr DfAIMgrCondition_OnLoop46_next(nullptr);
        static info::DfAIMgrCondition_OnLoop46_clbk DfAIMgrCondition_OnLoop46_user(nullptr);
        static info::DfAIMgrctor_DfAIMgr48_ptr DfAIMgrctor_DfAIMgr48_next(nullptr);
        static info::DfAIMgrctor_DfAIMgr48_clbk DfAIMgrctor_DfAIMgr48_user(nullptr);
        static info::DfAIMgrEmotion_OnChange50_ptr DfAIMgrEmotion_OnChange50_next(nullptr);
        static info::DfAIMgrEmotion_OnChange50_clbk DfAIMgrEmotion_OnChange50_user(nullptr);
        static info::DfAIMgrEmotion_OnLoop52_ptr DfAIMgrEmotion_OnLoop52_next(nullptr);
        static info::DfAIMgrEmotion_OnLoop52_clbk DfAIMgrEmotion_OnLoop52_user(nullptr);
        static info::DfAIMgrGetWisdomTarget54_ptr DfAIMgrGetWisdomTarget54_next(nullptr);
        static info::DfAIMgrGetWisdomTarget54_clbk DfAIMgrGetWisdomTarget54_user(nullptr);
        static info::DfAIMgrMon_SearchStart_OnLoop56_ptr DfAIMgrMon_SearchStart_OnLoop56_next(nullptr);
        static info::DfAIMgrMon_SearchStart_OnLoop56_clbk DfAIMgrMon_SearchStart_OnLoop56_user(nullptr);
        static info::DfAIMgrMon_Searched_Handler58_ptr DfAIMgrMon_Searched_Handler58_next(nullptr);
        static info::DfAIMgrMon_Searched_Handler58_clbk DfAIMgrMon_Searched_Handler58_user(nullptr);
        static info::DfAIMgrMv_Go_OnLoop60_ptr DfAIMgrMv_Go_OnLoop60_next(nullptr);
        static info::DfAIMgrMv_Go_OnLoop60_clbk DfAIMgrMv_Go_OnLoop60_user(nullptr);
        static info::DfAIMgrMv_Stop_Handler62_ptr DfAIMgrMv_Stop_Handler62_next(nullptr);
        static info::DfAIMgrMv_Stop_Handler62_clbk DfAIMgrMv_Stop_Handler62_user(nullptr);
        static info::DfAIMgrOnDFInitHFSM64_ptr DfAIMgrOnDFInitHFSM64_next(nullptr);
        static info::DfAIMgrOnDFInitHFSM64_clbk DfAIMgrOnDFInitHFSM64_user(nullptr);
        static info::DfAIMgrOnDfExternCallFun66_ptr DfAIMgrOnDfExternCallFun66_next(nullptr);
        static info::DfAIMgrOnDfExternCallFun66_clbk DfAIMgrOnDfExternCallFun66_user(nullptr);
        static info::DfAIMgrOnUsStateTBLInit68_ptr DfAIMgrOnUsStateTBLInit68_next(nullptr);
        static info::DfAIMgrOnUsStateTBLInit68_clbk DfAIMgrOnUsStateTBLInit68_user(nullptr);
        static info::DfAIMgrSearchCharacterPath70_ptr DfAIMgrSearchCharacterPath70_next(nullptr);
        static info::DfAIMgrSearchCharacterPath70_clbk DfAIMgrSearchCharacterPath70_user(nullptr);
        static info::DfAIMgrSearchPatrollPath72_ptr DfAIMgrSearchPatrollPath72_next(nullptr);
        static info::DfAIMgrSearchPatrollPath72_clbk DfAIMgrSearchPatrollPath72_user(nullptr);
        static info::DfAIMgrUseSkill_Target74_ptr DfAIMgrUseSkill_Target74_next(nullptr);
        static info::DfAIMgrUseSkill_Target74_clbk DfAIMgrUseSkill_Target74_user(nullptr);
        static info::DfAIMgrdtor_DfAIMgr79_ptr DfAIMgrdtor_DfAIMgr79_next(nullptr);
        static info::DfAIMgrdtor_DfAIMgr79_clbk DfAIMgrdtor_DfAIMgr79_user(nullptr);
        
        static void DfAIMgrAction_Attack_OnLoop2_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAction_Attack_OnLoop2_user(pHFS, dwEvent, lpParam, DfAIMgrAction_Attack_OnLoop2_next);
        };
        static void DfAIMgrAction_Change_Handler4_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAction_Change_Handler4_user(pHFS, dwEvent, lpParam, DfAIMgrAction_Change_Handler4_next);
        };
        static void DfAIMgrAction_Patrol_OnLoop6_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAction_Patrol_OnLoop6_user(pHFS, dwEvent, lpParam, DfAIMgrAction_Patrol_OnLoop6_next);
        };
        static void DfAIMgrAction_Runaway_OnLoop8_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAction_Runaway_OnLoop8_user(pHFS, dwEvent, lpParam, DfAIMgrAction_Runaway_OnLoop8_next);
        };
        static void DfAIMgrAction_Wait_OnLoop10_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAction_Wait_OnLoop10_user(pHFS, dwEvent, lpParam, DfAIMgrAction_Wait_OnLoop10_next);
        };
        static void DfAIMgrAssist_OnChange12_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAssist_OnChange12_user(pHFS, dwEvent, lpParam, DfAIMgrAssist_OnChange12_next);
        };
        static void DfAIMgrAssist_OnLoop14_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAssist_OnLoop14_user(pHFS, dwEvent, lpParam, DfAIMgrAssist_OnLoop14_next);
        };
        static void DfAIMgrAtp_Lost_Handler16_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAtp_Lost_Handler16_user(pHFS, dwEvent, lpParam, DfAIMgrAtp_Lost_Handler16_next);
        };
        static void DfAIMgrAtp_SearchStart_OnLoop18_wrapper(struct Us_HFSM* p, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAtp_SearchStart_OnLoop18_user(p, dwEvent, lpParam, DfAIMgrAtp_SearchStart_OnLoop18_next);
        };
        static void DfAIMgrAtp_Searched_Handler20_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrAtp_Searched_Handler20_user(pHFS, dwEvent, lpParam, DfAIMgrAtp_Searched_Handler20_next);
        };
        static void DfAIMgrChangeTargetPos22_wrapper(struct CMonster* pMon, float* pTarPos)
        {
           DfAIMgrChangeTargetPos22_user(pMon, pTarPos, DfAIMgrChangeTargetPos22_next);
        };
        static int DfAIMgrCheckAlienation24_wrapper(struct CMonster* pMon)
        {
           return DfAIMgrCheckAlienation24_user(pMon, DfAIMgrCheckAlienation24_next);
        };
        static int DfAIMgrCheckEmotionBad26_wrapper(struct CMonster* pMon, struct CMonsterAI* pAI, int nDamage)
        {
           return DfAIMgrCheckEmotionBad26_user(pMon, pAI, nDamage, DfAIMgrCheckEmotionBad26_next);
        };
        static int DfAIMgrCheckGen28_wrapper(struct CMonsterAI* pAI, struct CMonster* pMon)
        {
           return DfAIMgrCheckGen28_user(pAI, pMon, DfAIMgrCheckGen28_next);
        };
        static int DfAIMgrCheckMonArea_N_ChangeState30_wrapper(struct CMonsterAI* pAI, struct CMonster* pMon, int bAttackState)
        {
           return DfAIMgrCheckMonArea_N_ChangeState30_user(pAI, pMon, bAttackState, DfAIMgrCheckMonArea_N_ChangeState30_next);
        };
        static int DfAIMgrCheckSPF32_wrapper(struct CMonsterAI* pAI, struct CMonster* pMon)
        {
           return DfAIMgrCheckSPF32_user(pAI, pMon, DfAIMgrCheckSPF32_next);
        };
        static int DfAIMgrCheckSPFDelayTime34_wrapper(struct CMonsterAI* pAI, int nAttackType, unsigned int dwLoopTime)
        {
           return DfAIMgrCheckSPFDelayTime34_user(pAI, nAttackType, dwLoopTime, DfAIMgrCheckSPFDelayTime34_next);
        };
        static int DfAIMgrCheckSPF_MON_MOTIVE_ATTACK_MODE_PASSAGE36_wrapper(struct CMonsterSkill* pSkill, int nMotiveValue, struct CMonsterAI* pAI, struct CMonster* pMon, struct CCharacter** ppTar)
        {
        ...
        static int DfAIMgrCheckSPF_MON_MOTIVE_DF38_wrapper(struct CMonsterSkill* pSkill, int nMotiveValue, struct CMonsterAI* pAI, struct CMonster* pMon, struct CCharacter** ppTar)
        {
           return DfAIMgrCheckSPF_MON_MOTIVE_DF38_user(pSkill, nMotiveValue, pAI, pMon, ppTar, DfAIMgrCheckSPF_MON_MOTIVE_DF38_next);
        };
        static int DfAIMgrCheckSPF_MON_MOTIVE_MY_HP_DOWN40_wrapper(struct CMonsterSkill* pSkill, int nMotiveValue, struct CMonsterAI* pAI, struct CMonster* pMon, struct CCharacter** ppTar)
        {
        ...
        static int DfAIMgrCheckSPF_MON_MOTIVE_OTHER_HP_DOWN42_wrapper(struct CMonsterSkill* pSkill, int nMotiveValue, struct CMonsterAI* pAI, struct CMonster* pMon, struct CCharacter** ppTar)
        {
        ...
        static void DfAIMgrCondition_OnChange44_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrCondition_OnChange44_user(pHFS, dwEvent, lpParam, DfAIMgrCondition_OnChange44_next);
        };
        static void DfAIMgrCondition_OnLoop46_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrCondition_OnLoop46_user(pHFS, dwEvent, lpParam, DfAIMgrCondition_OnLoop46_next);
        };
        static void DfAIMgrctor_DfAIMgr48_wrapper(struct DfAIMgr* _this)
        {
           DfAIMgrctor_DfAIMgr48_user(_this, DfAIMgrctor_DfAIMgr48_next);
        };
        static void DfAIMgrEmotion_OnChange50_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrEmotion_OnChange50_user(pHFS, dwEvent, lpParam, DfAIMgrEmotion_OnChange50_next);
        };
        static void DfAIMgrEmotion_OnLoop52_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrEmotion_OnLoop52_user(pHFS, dwEvent, lpParam, DfAIMgrEmotion_OnLoop52_next);
        };
        static struct CCharacter* DfAIMgrGetWisdomTarget54_wrapper(int nDstCaseType, struct CMonsterAI* pAI, struct CMonster* pMon)
        {
           return DfAIMgrGetWisdomTarget54_user(nDstCaseType, pAI, pMon, DfAIMgrGetWisdomTarget54_next);
        };
        static void DfAIMgrMon_SearchStart_OnLoop56_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrMon_SearchStart_OnLoop56_user(pHFS, dwEvent, lpParam, DfAIMgrMon_SearchStart_OnLoop56_next);
        };
        static void DfAIMgrMon_Searched_Handler58_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrMon_Searched_Handler58_user(pHFS, dwEvent, lpParam, DfAIMgrMon_Searched_Handler58_next);
        };
        static void DfAIMgrMv_Go_OnLoop60_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrMv_Go_OnLoop60_user(pHFS, dwEvent, lpParam, DfAIMgrMv_Go_OnLoop60_next);
        };
        static void DfAIMgrMv_Stop_Handler62_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam)
        {
           DfAIMgrMv_Stop_Handler62_user(pHFS, dwEvent, lpParam, DfAIMgrMv_Stop_Handler62_next);
        };
        static int DfAIMgrOnDFInitHFSM64_wrapper(struct UsStateTBL* pStateTBL, struct Us_HFSM* pHFSM)
        {
           return DfAIMgrOnDFInitHFSM64_user(pStateTBL, pHFSM, DfAIMgrOnDFInitHFSM64_next);
        };
        static void DfAIMgrOnDfExternCallFun66_wrapper(struct Us_HFSM* pHFS, unsigned int dwEvent, void* lpParam, int nParam)
        {
           DfAIMgrOnDfExternCallFun66_user(pHFS, dwEvent, lpParam, nParam, DfAIMgrOnDfExternCallFun66_next);
        };
        static int DfAIMgrOnUsStateTBLInit68_wrapper()
        {
           return DfAIMgrOnUsStateTBLInit68_user(DfAIMgrOnUsStateTBLInit68_next);
        };
        static bool DfAIMgrSearchCharacterPath70_wrapper(struct CMonsterAI* pAI, struct CMonster* pMon, struct CCharacter* pTarget)
        {
           return DfAIMgrSearchCharacterPath70_user(pAI, pMon, pTarget, DfAIMgrSearchCharacterPath70_next);
        };
        static void DfAIMgrSearchPatrollPath72_wrapper(struct CMonsterAI* pAI, struct CMonster* pMon)
        {
           DfAIMgrSearchPatrollPath72_user(pAI, pMon, DfAIMgrSearchPatrollPath72_next);
        };
        static int DfAIMgrUseSkill_Target74_wrapper(struct CMonster* pMon, struct CCharacter* pTarget, struct CMonsterSkill* pSkill)
        {
           return DfAIMgrUseSkill_Target74_user(pMon, pTarget, pSkill, DfAIMgrUseSkill_Target74_next);
        };
        static void DfAIMgrdtor_DfAIMgr79_wrapper(struct DfAIMgr* _this)
        {
           DfAIMgrdtor_DfAIMgr79_user(_this, DfAIMgrdtor_DfAIMgr79_next);
        };
        
        static hook_record DfAIMgr_functions[] = {
        {   (LPVOID)0x1401518e0L,
