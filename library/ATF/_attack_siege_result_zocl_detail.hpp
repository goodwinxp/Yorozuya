...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_attack_siege_result_zoclctor__attack_siege_result_zocl2_ptr _attack_siege_result_zoclctor__attack_siege_result_zocl2_next(nullptr);
        static info::_attack_siege_result_zoclctor__attack_siege_result_zocl2_clbk _attack_siege_result_zoclctor__attack_siege_result_zocl2_user(nullptr);
        static info::_attack_siege_result_zoclsize4_ptr _attack_siege_result_zoclsize4_next(nullptr);
        static info::_attack_siege_result_zoclsize4_clbk _attack_siege_result_zoclsize4_user(nullptr);
        
        static void _attack_siege_result_zoclctor__attack_siege_result_zocl2_wrapper(struct _attack_siege_result_zocl* _this)
        {
        ...
        static int _attack_siege_result_zoclsize4_wrapper(struct _attack_siege_result_zocl* _this)
        {
           return _attack_siege_result_zoclsize4_user(_this, _attack_siege_result_zoclsize4_next);
        };
        
        static hook_record _attack_siege_result_zocl_functions[] = {
        {   (LPVOID)0x1400eefd0L,
