...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_darkhole_job_pass_inform_zoclsize2_ptr _darkhole_job_pass_inform_zoclsize2_next(nullptr);
        static info::_darkhole_job_pass_inform_zoclsize2_clbk _darkhole_job_pass_inform_zoclsize2_user(nullptr);
        
        static int _darkhole_job_pass_inform_zoclsize2_wrapper(struct _darkhole_job_pass_inform_zocl* _this)
        {
           return _darkhole_job_pass_inform_zoclsize2_user(_this, _darkhole_job_pass_inform_zoclsize2_next);
        };
        
        static hook_record _darkhole_job_pass_inform_zocl_functions[] = {
        {   (LPVOID)0x14026f840L,
