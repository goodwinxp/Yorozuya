...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_target_player_damage_contsf_allinform_zoclInit2_ptr _target_player_damage_contsf_allinform_zoclInit2_next(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclInit2_clbk _target_player_damage_contsf_allinform_zoclInit2_user(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclIsSame4_ptr _target_player_damage_contsf_allinform_zoclIsSame4_next(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclIsSame4_clbk _target_player_damage_contsf_allinform_zoclIsSame4_user(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclctor__target_player_damage_contsf_allinform_zocl6_ptr _target_player_damage_contsf_allinform_zoclctor__target_player_damage_contsf_allinform_zocl6_next(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclctor__target_player_damage_contsf_allinform_zocl6_clbk _target_player_damage_contsf_allinform_zoclctor__target_player_damage_contsf_allinform_zocl6_user(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclsize8_ptr _target_player_damage_contsf_allinform_zoclsize8_next(nullptr);
        static info::_target_player_damage_contsf_allinform_zoclsize8_clbk _target_player_damage_contsf_allinform_zoclsize8_user(nullptr);
        
        static void _target_player_damage_contsf_allinform_zoclInit2_wrapper(struct _target_player_damage_contsf_allinform_zocl* _this)
        {
           _target_player_damage_contsf_allinform_zoclInit2_user(_this, _target_player_damage_contsf_allinform_zoclInit2_next);
        };
        static bool _target_player_damage_contsf_allinform_zoclIsSame4_wrapper(struct _target_player_damage_contsf_allinform_zocl* src1, struct _target_player_damage_contsf_allinform_zocl* src2)
        {
        ...
        static void _target_player_damage_contsf_allinform_zoclctor__target_player_damage_contsf_allinform_zocl6_wrapper(struct _target_player_damage_contsf_allinform_zocl* _this)
        {
        ...
        static int _target_player_damage_contsf_allinform_zoclsize8_wrapper(struct _target_player_damage_contsf_allinform_zocl* _this)
        {
           return _target_player_damage_contsf_allinform_zoclsize8_user(_this, _target_player_damage_contsf_allinform_zoclsize8_next);
        };
        
        static hook_record _target_player_damage_contsf_allinform_zocl_functions[] = {
        {   (LPVOID)0x140074110L,
