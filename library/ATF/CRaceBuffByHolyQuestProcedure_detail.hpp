...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CRaceBuffByHolyQuestProcedurector_CRaceBuffByHolyQuestProcedure2_ptr CRaceBuffByHolyQuestProcedurector_CRaceBuffByHolyQuestProcedure2_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedurector_CRaceBuffByHolyQuestProcedure2_clbk CRaceBuffByHolyQuestProcedurector_CRaceBuffByHolyQuestProcedure2_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureCancelPlayerRaceBuff4_ptr CRaceBuffByHolyQuestProcedureCancelPlayerRaceBuff4_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureCancelPlayerRaceBuff4_clbk CRaceBuffByHolyQuestProcedureCancelPlayerRaceBuff4_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureCreateComplete6_ptr CRaceBuffByHolyQuestProcedureCreateComplete6_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureCreateComplete6_clbk CRaceBuffByHolyQuestProcedureCreateComplete6_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureGetRaceBuffLevel8_ptr CRaceBuffByHolyQuestProcedureGetRaceBuffLevel8_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureGetRaceBuffLevel8_clbk CRaceBuffByHolyQuestProcedureGetRaceBuffLevel8_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureInit10_ptr CRaceBuffByHolyQuestProcedureInit10_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureInit10_clbk CRaceBuffByHolyQuestProcedureInit10_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureLoop12_ptr CRaceBuffByHolyQuestProcedureLoop12_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureLoop12_clbk CRaceBuffByHolyQuestProcedureLoop12_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureLoopSubProcSetRaceBuff14_ptr CRaceBuffByHolyQuestProcedureLoopSubProcSetRaceBuff14_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureLoopSubProcSetRaceBuff14_clbk CRaceBuffByHolyQuestProcedureLoopSubProcSetRaceBuff14_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequest16_ptr CRaceBuffByHolyQuestProcedureRequest16_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequest16_clbk CRaceBuffByHolyQuestProcedureRequest16_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcCancelRaceBuff18_ptr CRaceBuffByHolyQuestProcedureRequestSubProcCancelRaceBuff18_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcCancelRaceBuff18_clbk CRaceBuffByHolyQuestProcedureRequestSubProcCancelRaceBuff18_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBattleResult20_ptr CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBattleResult20_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBattleResult20_clbk CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBattleResult20_user(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBuff22_ptr CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBuff22_next(nullptr);
        static info::CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBuff22_clbk CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBuff22_user(nullptr);
        static info::CRaceBuffByHolyQuestProceduredtor_CRaceBuffByHolyQuestProcedure24_ptr CRaceBuffByHolyQuestProceduredtor_CRaceBuffByHolyQuestProcedure24_next(nullptr);
        static info::CRaceBuffByHolyQuestProceduredtor_CRaceBuffByHolyQuestProcedure24_clbk CRaceBuffByHolyQuestProceduredtor_CRaceBuffByHolyQuestProcedure24_user(nullptr);
        
        static void CRaceBuffByHolyQuestProcedurector_CRaceBuffByHolyQuestProcedure2_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static int CRaceBuffByHolyQuestProcedureCancelPlayerRaceBuff4_wrapper(struct CRaceBuffByHolyQuestProcedure* _this, struct CPlayer* pkPlayer, CRaceBuffInfoByHolyQuestfGroup::RESULT_TYPE eReleaseType, unsigned int uiReleaseLv)
        {
        ...
        static bool CRaceBuffByHolyQuestProcedureCreateComplete6_wrapper(struct CRaceBuffByHolyQuestProcedure* _this, struct CPlayer* pkPlayer)
        {
        ...
        static int CRaceBuffByHolyQuestProcedureGetRaceBuffLevel8_wrapper(struct CRaceBuffByHolyQuestProcedure* _this, struct CPlayer* pOne)
        {
        ...
        static bool CRaceBuffByHolyQuestProcedureInit10_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
           return CRaceBuffByHolyQuestProcedureInit10_user(_this, CRaceBuffByHolyQuestProcedureInit10_next);
        };
        static void CRaceBuffByHolyQuestProcedureLoop12_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
           CRaceBuffByHolyQuestProcedureLoop12_user(_this, CRaceBuffByHolyQuestProcedureLoop12_next);
        };
        static void CRaceBuffByHolyQuestProcedureLoopSubProcSetRaceBuff14_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static bool CRaceBuffByHolyQuestProcedureRequest16_wrapper(struct CRaceBuffByHolyQuestProcedure* _this, int iType)
        {
           return CRaceBuffByHolyQuestProcedureRequest16_user(_this, iType, CRaceBuffByHolyQuestProcedureRequest16_next);
        };
        static bool CRaceBuffByHolyQuestProcedureRequestSubProcCancelRaceBuff18_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static bool CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBattleResult20_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static bool CRaceBuffByHolyQuestProcedureRequestSubProcSetRaceBuff22_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static void CRaceBuffByHolyQuestProceduredtor_CRaceBuffByHolyQuestProcedure24_wrapper(struct CRaceBuffByHolyQuestProcedure* _this)
        {
        ...
        static hook_record CRaceBuffByHolyQuestProcedure_functions[] = {
        {   (LPVOID)0x1403b60f0L,
