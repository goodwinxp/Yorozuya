...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CLuaSignalReActor___ActionInit2_ptr = void (WINAPIV*)(struct CLuaSignalReActor::_Action*);
        using CLuaSignalReActor___ActionInit2_clbk = void (WINAPIV*)(struct CLuaSignalReActor::_Action*, CLuaSignalReActor___ActionInit2_ptr);
        using CLuaSignalReActor___Actionctor__Action4_ptr = void (WINAPIV*)(struct CLuaSignalReActor::_Action*);
        using CLuaSignalReActor___Actionctor__Action4_clbk = void (WINAPIV*)(struct CLuaSignalReActor::_Action*, CLuaSignalReActor___Actionctor__Action4_ptr);
