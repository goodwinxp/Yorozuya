...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using _talk_crystal_matrial_combine_nodePush12_ptr = bool (WINAPIV*)(struct _talk_crystal_matrial_combine_node*, struct _STORAGE_LIST::_db_con*, char, char);
        using _talk_crystal_matrial_combine_nodePush12_clbk = bool (WINAPIV*)(struct _talk_crystal_matrial_combine_node*, struct _STORAGE_LIST::_db_con*, char, char, _talk_crystal_matrial_combine_nodePush12_ptr);
        ...
        using _talk_crystal_matrial_combine_node___matrialinfoInit2_ptr = void (WINAPIV*)(struct _talk_crystal_matrial_combine_node::_matrialinfo*);
        using _talk_crystal_matrial_combine_node___matrialinfoInit2_clbk = void (WINAPIV*)(struct _talk_crystal_matrial_combine_node::_matrialinfo*, _talk_crystal_matrial_combine_node___matrialinfoInit2_ptr);
        using _talk_crystal_matrial_combine_node___matrialinfoctor__matrialinfo4_ptr = void (WINAPIV*)(struct _talk_crystal_matrial_combine_node::_matrialinfo*);
        using _talk_crystal_matrial_combine_node___matrialinfoctor__matrialinfo4_clbk = void (WINAPIV*)(struct _talk_crystal_matrial_combine_node::_matrialinfo*, _talk_crystal_matrial_combine_node___matrialinfoctor__matrialinfo4_ptr);
