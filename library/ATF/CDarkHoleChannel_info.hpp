...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CDarkHoleChannel____enter_memberctor___enter_member2_ptr = void (WINAPIV*)(struct CDarkHoleChannel::__enter_member*, bool, bool, unsigned int);
        using CDarkHoleChannel____enter_memberctor___enter_member2_clbk = void (WINAPIV*)(struct CDarkHoleChannel::__enter_member*, bool, bool, unsigned int, CDarkHoleChannel____enter_memberctor___enter_member2_ptr);
        using CDarkHoleChannel____enter_memberctor___enter_member4_ptr = void (WINAPIV*)(struct CDarkHoleChannel::__enter_member*);
        using CDarkHoleChannel____enter_memberctor___enter_member4_clbk = void (WINAPIV*)(struct CDarkHoleChannel::__enter_member*, CDarkHoleChannel____enter_memberctor___enter_member4_ptr);
