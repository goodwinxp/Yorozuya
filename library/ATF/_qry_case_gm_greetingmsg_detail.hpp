...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_qry_case_gm_greetingmsgsize2_ptr _qry_case_gm_greetingmsgsize2_next(nullptr);
        static info::_qry_case_gm_greetingmsgsize2_clbk _qry_case_gm_greetingmsgsize2_user(nullptr);
        
        static int _qry_case_gm_greetingmsgsize2_wrapper(struct _qry_case_gm_greetingmsg* _this)
        {
           return _qry_case_gm_greetingmsgsize2_user(_this, _qry_case_gm_greetingmsgsize2_next);
        };
        
        static hook_record _qry_case_gm_greetingmsg_functions[] = {
        {   (LPVOID)0x140208240L,
