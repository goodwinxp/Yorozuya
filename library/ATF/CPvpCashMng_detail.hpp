...
#include "CPvpCashMng_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::CPvpCashMngctor_CPvpCashMng2_ptr CPvpCashMngctor_CPvpCashMng2_next(nullptr);
        static info::CPvpCashMngctor_CPvpCashMng2_clbk CPvpCashMngctor_CPvpCashMng2_user(nullptr);
        static info::CPvpCashMngGetMaxTempPoint4_ptr CPvpCashMngGetMaxTempPoint4_next(nullptr);
        static info::CPvpCashMngGetMaxTempPoint4_clbk CPvpCashMngGetMaxTempPoint4_user(nullptr);
        static info::CPvpCashMngGetMinTempPoint6_ptr CPvpCashMngGetMinTempPoint6_next(nullptr);
        static info::CPvpCashMngGetMinTempPoint6_clbk CPvpCashMngGetMinTempPoint6_user(nullptr);
        static info::CPvpCashMngGetMyClassVal8_ptr CPvpCashMngGetMyClassVal8_next(nullptr);
        static info::CPvpCashMngGetMyClassVal8_clbk CPvpCashMngGetMyClassVal8_user(nullptr);
        static info::CPvpCashMngGetTalikNum10_ptr CPvpCashMngGetTalikNum10_next(nullptr);
        static info::CPvpCashMngGetTalikNum10_clbk CPvpCashMngGetTalikNum10_user(nullptr);
        static info::CPvpCashMngGetTalikRecvrPoint12_ptr CPvpCashMngGetTalikRecvrPoint12_next(nullptr);
        static info::CPvpCashMngGetTalikRecvrPoint12_clbk CPvpCashMngGetTalikRecvrPoint12_user(nullptr);
        static info::CPvpCashMngGetTalikRecvrPoint14_ptr CPvpCashMngGetTalikRecvrPoint14_next(nullptr);
        static info::CPvpCashMngGetTalikRecvrPoint14_clbk CPvpCashMngGetTalikRecvrPoint14_user(nullptr);
        static info::CPvpCashMngInstance16_ptr CPvpCashMngInstance16_next(nullptr);
        static info::CPvpCashMngInstance16_clbk CPvpCashMngInstance16_user(nullptr);
        static info::CPvpCashMngIsTalikItem18_ptr CPvpCashMngIsTalikItem18_next(nullptr);
        static info::CPvpCashMngIsTalikItem18_clbk CPvpCashMngIsTalikItem18_user(nullptr);
        static info::CPvpCashMngLoadData20_ptr CPvpCashMngLoadData20_next(nullptr);
        static info::CPvpCashMngLoadData20_clbk CPvpCashMngLoadData20_user(nullptr);
        static info::CPvpCashMngParsing22_ptr CPvpCashMngParsing22_next(nullptr);
        static info::CPvpCashMngParsing22_clbk CPvpCashMngParsing22_user(nullptr);
        static info::CPvpCashMngRelease24_ptr CPvpCashMngRelease24_next(nullptr);
        static info::CPvpCashMngRelease24_clbk CPvpCashMngRelease24_user(nullptr);
        static info::CPvpCashMngSetItem26_ptr CPvpCashMngSetItem26_next(nullptr);
        static info::CPvpCashMngSetItem26_clbk CPvpCashMngSetItem26_user(nullptr);
        static info::CPvpCashMngdtor_CPvpCashMng30_ptr CPvpCashMngdtor_CPvpCashMng30_next(nullptr);
        static info::CPvpCashMngdtor_CPvpCashMng30_clbk CPvpCashMngdtor_CPvpCashMng30_user(nullptr);
        
        static void CPvpCashMngctor_CPvpCashMng2_wrapper(struct CPvpCashMng* _this)
        {
           CPvpCashMngctor_CPvpCashMng2_user(_this, CPvpCashMngctor_CPvpCashMng2_next);
        };
        static int CPvpCashMngGetMaxTempPoint4_wrapper(struct CPvpCashMng* _this, char nLv, bool bPremium)
        {
           return CPvpCashMngGetMaxTempPoint4_user(_this, nLv, bPremium, CPvpCashMngGetMaxTempPoint4_next);
        };
        static int CPvpCashMngGetMinTempPoint6_wrapper(struct CPvpCashMng* _this, char nLv)
        {
           return CPvpCashMngGetMinTempPoint6_user(_this, nLv, CPvpCashMngGetMinTempPoint6_next);
        };
        static int CPvpCashMngGetMyClassVal8_wrapper(struct CPvpCashMng* _this, char* pClass)
        {
           return CPvpCashMngGetMyClassVal8_user(_this, pClass, CPvpCashMngGetMyClassVal8_next);
        };
        static int CPvpCashMngGetTalikNum10_wrapper(struct CPvpCashMng* _this)
        {
           return CPvpCashMngGetTalikNum10_user(_this, CPvpCashMngGetTalikNum10_next);
        };
        static int CPvpCashMngGetTalikRecvrPoint12_wrapper(struct CPvpCashMng* _this, int i)
        {
           return CPvpCashMngGetTalikRecvrPoint12_user(_this, i, CPvpCashMngGetTalikRecvrPoint12_next);
        };
        static int CPvpCashMngGetTalikRecvrPoint14_wrapper(struct CPvpCashMng* _this, char byTblCode, unsigned int dwIndex)
        {
           return CPvpCashMngGetTalikRecvrPoint14_user(_this, byTblCode, dwIndex, CPvpCashMngGetTalikRecvrPoint14_next);
        };
        static struct CPvpCashMng* CPvpCashMngInstance16_wrapper()
        {
           return CPvpCashMngInstance16_user(CPvpCashMngInstance16_next);
        };
        static bool CPvpCashMngIsTalikItem18_wrapper(struct CPvpCashMng* _this, char* strCode)
        {
           return CPvpCashMngIsTalikItem18_user(_this, strCode, CPvpCashMngIsTalikItem18_next);
        };
        static bool CPvpCashMngLoadData20_wrapper(struct CPvpCashMng* _this)
        {
           return CPvpCashMngLoadData20_user(_this, CPvpCashMngLoadData20_next);
        };
        static bool CPvpCashMngParsing22_wrapper(struct CPvpCashMng* _this, char* szTitle, char* szItem, char** szBuff, int nInx, char byParseType)
        {
           return CPvpCashMngParsing22_user(_this, szTitle, szItem, szBuff, nInx, byParseType, CPvpCashMngParsing22_next);
        };
        static void CPvpCashMngRelease24_wrapper(struct CPvpCashMng* _this)
        {
           CPvpCashMngRelease24_user(_this, CPvpCashMngRelease24_next);
        };
        static bool CPvpCashMngSetItem26_wrapper(struct CPvpCashMng* _this, char* szItemCode, int nInx)
        {
           return CPvpCashMngSetItem26_user(_this, szItemCode, nInx, CPvpCashMngSetItem26_next);
        };
        static void CPvpCashMngdtor_CPvpCashMng30_wrapper(struct CPvpCashMng* _this)
        {
           CPvpCashMngdtor_CPvpCashMng30_user(_this, CPvpCashMngdtor_CPvpCashMng30_next);
        };
        
        static hook_record CPvpCashMng_functions[] = {
        {   (LPVOID)0x1403f6e20L,
