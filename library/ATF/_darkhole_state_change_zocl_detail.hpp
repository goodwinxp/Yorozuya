...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_darkhole_state_change_zoclsize2_ptr _darkhole_state_change_zoclsize2_next(nullptr);
        static info::_darkhole_state_change_zoclsize2_clbk _darkhole_state_change_zoclsize2_user(nullptr);
        
        static int _darkhole_state_change_zoclsize2_wrapper(struct _darkhole_state_change_zocl* _this)
        {
           return _darkhole_state_change_zoclsize2_user(_this, _darkhole_state_change_zoclsize2_next);
        };
        
        static hook_record _darkhole_state_change_zocl_functions[] = {
        {   (LPVOID)0x1401648f0L,
