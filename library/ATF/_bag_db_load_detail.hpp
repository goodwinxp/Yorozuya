...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_bag_db_loadctor__bag_db_load2_ptr _bag_db_loadctor__bag_db_load2_next(nullptr);
        static info::_bag_db_loadctor__bag_db_load2_clbk _bag_db_loadctor__bag_db_load2_user(nullptr);
        
        static void _bag_db_loadctor__bag_db_load2_wrapper(struct _bag_db_load* _this)
        {
           _bag_db_loadctor__bag_db_load2_user(_this, _bag_db_loadctor__bag_db_load2_next);
        };
        
        static hook_record _bag_db_load_functions[] = {
        {   (LPVOID)0x14010da90L,
