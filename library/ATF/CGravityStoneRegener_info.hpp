...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CGravityStoneRegenerGetStateString14_ptr = char* (WINAPIV*)(struct CGravityStoneRegener*, struct ATL::CStringT<char,StrTraitMFC_DLL<char,ATL::ChTraitsCRT<char> > >*);
        using CGravityStoneRegenerGetStateString14_clbk = char* (WINAPIV*)(struct CGravityStoneRegener*, struct ATL::CStringT<char,StrTraitMFC_DLL<char,ATL::ChTraitsCRT<char> > >*, CGravityStoneRegenerGetStateString14_ptr);
