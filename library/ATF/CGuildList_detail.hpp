...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CGuildListAddList2_ptr CGuildListAddList2_next(nullptr);
        static info::CGuildListAddList2_clbk CGuildListAddList2_user(nullptr);
        static info::CGuildListctor_CGuildList4_ptr CGuildListctor_CGuildList4_next(nullptr);
        static info::CGuildListctor_CGuildList4_clbk CGuildListctor_CGuildList4_user(nullptr);
        static info::CGuildListInit6_ptr CGuildListInit6_next(nullptr);
        static info::CGuildListInit6_clbk CGuildListInit6_user(nullptr);
        static info::CGuildListSendList8_ptr CGuildListSendList8_next(nullptr);
        static info::CGuildListSendList8_clbk CGuildListSendList8_user(nullptr);
        static info::CGuildListSetGrade10_ptr CGuildListSetGrade10_next(nullptr);
        static info::CGuildListSetGrade10_clbk CGuildListSetGrade10_user(nullptr);
        static info::CGuildListSetGuildMaster12_ptr CGuildListSetGuildMaster12_next(nullptr);
        static info::CGuildListSetGuildMaster12_clbk CGuildListSetGuildMaster12_user(nullptr);
        static info::CGuildListdtor_CGuildList17_ptr CGuildListdtor_CGuildList17_next(nullptr);
        static info::CGuildListdtor_CGuildList17_clbk CGuildListdtor_CGuildList17_user(nullptr);
        
        static void CGuildListAddList2_wrapper(struct CGuildList* _this, char byRace, char byGrade, char* pwszGuildName, char* pwszMasterName)
        {
           CGuildListAddList2_user(_this, byRace, byGrade, pwszGuildName, pwszMasterName, CGuildListAddList2_next);
        };
        static void CGuildListctor_CGuildList4_wrapper(struct CGuildList* _this)
        {
           CGuildListctor_CGuildList4_user(_this, CGuildListctor_CGuildList4_next);
        };
        static bool CGuildListInit6_wrapper(struct CGuildList* _this)
        {
           return CGuildListInit6_user(_this, CGuildListInit6_next);
        };
        static void CGuildListSendList8_wrapper(struct CGuildList* _this, uint16_t wIndex, char byRace, char byPage)
        {
           CGuildListSendList8_user(_this, wIndex, byRace, byPage, CGuildListSendList8_next);
        };
        static void CGuildListSetGrade10_wrapper(struct CGuildList* _this, char byRace, char* pwszGuildName, char byGrade)
        {
           CGuildListSetGrade10_user(_this, byRace, pwszGuildName, byGrade, CGuildListSetGrade10_next);
        };
        static void CGuildListSetGuildMaster12_wrapper(struct CGuildList* _this, char byRace, char* pwszGuildName, char* pwszMasterName)
        {
           CGuildListSetGuildMaster12_user(_this, byRace, pwszGuildName, pwszMasterName, CGuildListSetGuildMaster12_next);
        };
        static void CGuildListdtor_CGuildList17_wrapper(struct CGuildList* _this)
        {
           CGuildListdtor_CGuildList17_user(_this, CGuildListdtor_CGuildList17_next);
        };
        
        static hook_record CGuildList_functions[] = {
        {   (LPVOID)0x14025d900L,
