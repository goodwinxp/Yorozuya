...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_ptr CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_next(nullptr);
        static info::CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_clbk CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_user(nullptr);
        static info::CMoveMapLimitInfoListCleanUp4_ptr CMoveMapLimitInfoListCleanUp4_next(nullptr);
        static info::CMoveMapLimitInfoListCleanUp4_clbk CMoveMapLimitInfoListCleanUp4_user(nullptr);
        static info::CMoveMapLimitInfoListGet6_ptr CMoveMapLimitInfoListGet6_next(nullptr);
        static info::CMoveMapLimitInfoListGet6_clbk CMoveMapLimitInfoListGet6_user(nullptr);
        static info::CMoveMapLimitInfoListInit8_ptr CMoveMapLimitInfoListInit8_next(nullptr);
        static info::CMoveMapLimitInfoListInit8_clbk CMoveMapLimitInfoListInit8_user(nullptr);
        static info::CMoveMapLimitInfoListLoad10_ptr CMoveMapLimitInfoListLoad10_next(nullptr);
        static info::CMoveMapLimitInfoListLoad10_clbk CMoveMapLimitInfoListLoad10_user(nullptr);
        static info::CMoveMapLimitInfoListLogIn12_ptr CMoveMapLimitInfoListLogIn12_next(nullptr);
        static info::CMoveMapLimitInfoListLogIn12_clbk CMoveMapLimitInfoListLogIn12_user(nullptr);
        static info::CMoveMapLimitInfoListLogOut14_ptr CMoveMapLimitInfoListLogOut14_next(nullptr);
        static info::CMoveMapLimitInfoListLogOut14_clbk CMoveMapLimitInfoListLogOut14_user(nullptr);
        static info::CMoveMapLimitInfoListLoop16_ptr CMoveMapLimitInfoListLoop16_next(nullptr);
        static info::CMoveMapLimitInfoListLoop16_clbk CMoveMapLimitInfoListLoop16_user(nullptr);
        static info::CMoveMapLimitInfoListRequest18_ptr CMoveMapLimitInfoListRequest18_next(nullptr);
        static info::CMoveMapLimitInfoListRequest18_clbk CMoveMapLimitInfoListRequest18_user(nullptr);
        static info::CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_ptr CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_next(nullptr);
        static info::CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_clbk CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_user(nullptr);
        
        static void CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_wrapper(struct CMoveMapLimitInfoList* _this)
        {
           CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_user(_this, CMoveMapLimitInfoListctor_CMoveMapLimitInfoList2_next);
        };
        static void CMoveMapLimitInfoListCleanUp4_wrapper(struct CMoveMapLimitInfoList* _this)
        {
           CMoveMapLimitInfoListCleanUp4_user(_this, CMoveMapLimitInfoListCleanUp4_next);
        };
        static struct CMoveMapLimitInfo* CMoveMapLimitInfoListGet6_wrapper(struct CMoveMapLimitInfoList* _this, int iLimitType, int iMapInx, unsigned int dwStoreRecordIndex)
        {
           return CMoveMapLimitInfoListGet6_user(_this, iLimitType, iMapInx, dwStoreRecordIndex, CMoveMapLimitInfoListGet6_next);
        };
        static bool CMoveMapLimitInfoListInit8_wrapper(struct CMoveMapLimitInfoList* _this, struct std::vector<int,std::allocator<int> >* vecRightTypeList)
        {
           return CMoveMapLimitInfoListInit8_user(_this, vecRightTypeList, CMoveMapLimitInfoListInit8_next);
        };
        static void CMoveMapLimitInfoListLoad10_wrapper(struct CMoveMapLimitInfoList* _this, struct CPlayer* pkPlayer, struct CMoveMapLimitRightInfo* pkRight)
        {
           CMoveMapLimitInfoListLoad10_user(_this, pkPlayer, pkRight, CMoveMapLimitInfoListLoad10_next);
        };
        static void CMoveMapLimitInfoListLogIn12_wrapper(struct CMoveMapLimitInfoList* _this, struct CPlayer* pkPlayer, struct CMoveMapLimitRightInfo* pkRight)
        {
           CMoveMapLimitInfoListLogIn12_user(_this, pkPlayer, pkRight, CMoveMapLimitInfoListLogIn12_next);
        };
        static void CMoveMapLimitInfoListLogOut14_wrapper(struct CMoveMapLimitInfoList* _this, struct CPlayer* pkPlayer, struct CMoveMapLimitRightInfo* pkRight)
        {
           CMoveMapLimitInfoListLogOut14_user(_this, pkPlayer, pkRight, CMoveMapLimitInfoListLogOut14_next);
        };
        static void CMoveMapLimitInfoListLoop16_wrapper(struct CMoveMapLimitInfoList* _this)
        {
           CMoveMapLimitInfoListLoop16_user(_this, CMoveMapLimitInfoListLoop16_next);
        };
        static char CMoveMapLimitInfoListRequest18_wrapper(struct CMoveMapLimitInfoList* _this, int iLimitType, int iRequetType, int iMapInx, unsigned int dwStoreRecordIndex, int iUserInx, char* pRequest, struct CMoveMapLimitRightInfo* pkRight)
        {
        ...
        static void CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_wrapper(struct CMoveMapLimitInfoList* _this)
        {
           CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_user(_this, CMoveMapLimitInfoListdtor_CMoveMapLimitInfoList20_next);
        };
        
        static hook_record CMoveMapLimitInfoList_functions[] = {
        {   (LPVOID)0x1403a1dc0L,
