...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_guildroom_enter_result_zoclsize2_ptr _guildroom_enter_result_zoclsize2_next(nullptr);
        static info::_guildroom_enter_result_zoclsize2_clbk _guildroom_enter_result_zoclsize2_user(nullptr);
        
        static int _guildroom_enter_result_zoclsize2_wrapper(struct _guildroom_enter_result_zocl* _this)
        {
           return _guildroom_enter_result_zoclsize2_user(_this, _guildroom_enter_result_zoclsize2_next);
        };
        
        static hook_record _guildroom_enter_result_zocl_functions[] = {
        {   (LPVOID)0x1400f03a0L,
