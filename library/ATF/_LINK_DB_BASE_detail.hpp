...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_LINK_DB_BASEInit2_ptr _LINK_DB_BASEInit2_next(nullptr);
        static info::_LINK_DB_BASEInit2_clbk _LINK_DB_BASEInit2_user(nullptr);
        static info::_LINK_DB_BASEctor__LINK_DB_BASE4_ptr _LINK_DB_BASEctor__LINK_DB_BASE4_next(nullptr);
        static info::_LINK_DB_BASEctor__LINK_DB_BASE4_clbk _LINK_DB_BASEctor__LINK_DB_BASE4_user(nullptr);
        
        static info::_LINK_DB_BASE___LISTInit2_ptr _LINK_DB_BASE___LISTInit2_next(nullptr);
        static info::_LINK_DB_BASE___LISTInit2_clbk _LINK_DB_BASE___LISTInit2_user(nullptr);
        static info::_LINK_DB_BASE___LISTctor__LIST4_ptr _LINK_DB_BASE___LISTctor__LIST4_next(nullptr);
        static info::_LINK_DB_BASE___LISTctor__LIST4_clbk _LINK_DB_BASE___LISTctor__LIST4_user(nullptr);
        
        static void _LINK_DB_BASEInit2_wrapper(struct _LINK_DB_BASE* _this)
        {
           _LINK_DB_BASEInit2_user(_this, _LINK_DB_BASEInit2_next);
        };
        static void _LINK_DB_BASEctor__LINK_DB_BASE4_wrapper(struct _LINK_DB_BASE* _this)
        {
           _LINK_DB_BASEctor__LINK_DB_BASE4_user(_this, _LINK_DB_BASEctor__LINK_DB_BASE4_next);
        };
        
        static void _LINK_DB_BASE___LISTInit2_wrapper(struct _LINK_DB_BASE::_LIST* _this)
        {
           _LINK_DB_BASE___LISTInit2_user(_this, _LINK_DB_BASE___LISTInit2_next);
        };
        static void _LINK_DB_BASE___LISTctor__LIST4_wrapper(struct _LINK_DB_BASE::_LIST* _this)
        {
           _LINK_DB_BASE___LISTctor__LIST4_user(_this, _LINK_DB_BASE___LISTctor__LIST4_next);
        };
        
        static hook_record _LINK_DB_BASE_functions[] = {
        {   (LPVOID)0x140075990L,
