...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CTransportShip____mgr_memberctor___mgr_member2_ptr = void (WINAPIV*)(struct CTransportShip::__mgr_member*);
        using CTransportShip____mgr_memberctor___mgr_member2_clbk = void (WINAPIV*)(struct CTransportShip::__mgr_member*, CTransportShip____mgr_memberctor___mgr_member2_ptr);
        using CTransportShip____mgr_memberinit4_ptr = void (WINAPIV*)(struct CTransportShip::__mgr_member*);
        using CTransportShip____mgr_memberinit4_clbk = void (WINAPIV*)(struct CTransportShip::__mgr_member*, CTransportShip____mgr_memberinit4_ptr);
        using CTransportShip____mgr_memberis_fill6_ptr = bool (WINAPIV*)(struct CTransportShip::__mgr_member*);
        using CTransportShip____mgr_memberis_fill6_clbk = bool (WINAPIV*)(struct CTransportShip::__mgr_member*, CTransportShip____mgr_memberis_fill6_ptr);
        
        using CTransportShip____mgr_ticketctor___mgr_ticket2_ptr = void (WINAPIV*)(struct CTransportShip::__mgr_ticket*);
        using CTransportShip____mgr_ticketctor___mgr_ticket2_clbk = void (WINAPIV*)(struct CTransportShip::__mgr_ticket*, CTransportShip____mgr_ticketctor___mgr_ticket2_ptr);
        using CTransportShip____mgr_ticketinit4_ptr = void (WINAPIV*)(struct CTransportShip::__mgr_ticket*);
        using CTransportShip____mgr_ticketinit4_clbk = void (WINAPIV*)(struct CTransportShip::__mgr_ticket*, CTransportShip____mgr_ticketinit4_ptr);
