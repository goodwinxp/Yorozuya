...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_guild_applier_infoIsFill2_ptr _guild_applier_infoIsFill2_next(nullptr);
        static info::_guild_applier_infoIsFill2_clbk _guild_applier_infoIsFill2_user(nullptr);
        static info::_guild_applier_infoctor__guild_applier_info4_ptr _guild_applier_infoctor__guild_applier_info4_next(nullptr);
        static info::_guild_applier_infoctor__guild_applier_info4_clbk _guild_applier_infoctor__guild_applier_info4_user(nullptr);
        static info::_guild_applier_infoinit6_ptr _guild_applier_infoinit6_next(nullptr);
        static info::_guild_applier_infoinit6_clbk _guild_applier_infoinit6_user(nullptr);
        
        static bool _guild_applier_infoIsFill2_wrapper(struct _guild_applier_info* _this)
        {
           return _guild_applier_infoIsFill2_user(_this, _guild_applier_infoIsFill2_next);
        };
        static void _guild_applier_infoctor__guild_applier_info4_wrapper(struct _guild_applier_info* _this)
        {
           _guild_applier_infoctor__guild_applier_info4_user(_this, _guild_applier_infoctor__guild_applier_info4_next);
        };
        static void _guild_applier_infoinit6_wrapper(struct _guild_applier_info* _this)
        {
           _guild_applier_infoinit6_user(_this, _guild_applier_infoinit6_next);
        };
        
        static hook_record _guild_applier_info_functions[] = {
        {   (LPVOID)0x14025d330L,
