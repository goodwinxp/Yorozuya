...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CAniCameraGetCameraIndex1_ptr CAniCameraGetCameraIndex1_next(nullptr);
        static info::CAniCameraGetCameraIndex1_clbk CAniCameraGetCameraIndex1_user(nullptr);
        static info::CAniCameraGetCameraName2_ptr CAniCameraGetCameraName2_next(nullptr);
        static info::CAniCameraGetCameraName2_clbk CAniCameraGetCameraName2_user(nullptr);
        static info::CAniCameraGetDummyID3_ptr CAniCameraGetDummyID3_next(nullptr);
        static info::CAniCameraGetDummyID3_clbk CAniCameraGetDummyID3_user(nullptr);
        static info::CAniCameraGetDummyMatrix4_ptr CAniCameraGetDummyMatrix4_next(nullptr);
        static info::CAniCameraGetDummyMatrix4_clbk CAniCameraGetDummyMatrix4_user(nullptr);
        static info::CAniCameraGetDummyMatrixSub5_ptr CAniCameraGetDummyMatrixSub5_next(nullptr);
        static info::CAniCameraGetDummyMatrixSub5_clbk CAniCameraGetDummyMatrixSub5_user(nullptr);
        static info::CAniCameraGetDummyParentID6_ptr CAniCameraGetDummyParentID6_next(nullptr);
        static info::CAniCameraGetDummyParentID6_clbk CAniCameraGetDummyParentID6_user(nullptr);
        static info::CAniCameraGetMatrixAniCamera7_ptr CAniCameraGetMatrixAniCamera7_next(nullptr);
        static info::CAniCameraGetMatrixAniCamera7_clbk CAniCameraGetMatrixAniCamera7_user(nullptr);
        static info::CAniCameraIsLoadedAniCamera8_ptr CAniCameraIsLoadedAniCamera8_next(nullptr);
        static info::CAniCameraIsLoadedAniCamera8_clbk CAniCameraIsLoadedAniCamera8_user(nullptr);
        static info::CAniCameraLoadAniCamera9_ptr CAniCameraLoadAniCamera9_next(nullptr);
        static info::CAniCameraLoadAniCamera9_clbk CAniCameraLoadAniCamera9_user(nullptr);
        static info::CAniCameraPlayAniCamera10_ptr CAniCameraPlayAniCamera10_next(nullptr);
        static info::CAniCameraPlayAniCamera10_clbk CAniCameraPlayAniCamera10_user(nullptr);
        static info::CAniCameraReleaseAniCamera11_ptr CAniCameraReleaseAniCamera11_next(nullptr);
        static info::CAniCameraReleaseAniCamera11_clbk CAniCameraReleaseAniCamera11_user(nullptr);
        static info::CAniCameraSetExtCamAni12_ptr CAniCameraSetExtCamAni12_next(nullptr);
        static info::CAniCameraSetExtCamAni12_clbk CAniCameraSetExtCamAni12_user(nullptr);
        static info::CAniCameraSetNowFrame13_ptr CAniCameraSetNowFrame13_next(nullptr);
        static info::CAniCameraSetNowFrame13_clbk CAniCameraSetNowFrame13_user(nullptr);
        static info::CAniCameraSetPrePlayCamera14_ptr CAniCameraSetPrePlayCamera14_next(nullptr);
        static info::CAniCameraSetPrePlayCamera14_clbk CAniCameraSetPrePlayCamera14_user(nullptr);
        static info::CAniCameradtor_CAniCamera15_ptr CAniCameradtor_CAniCamera15_next(nullptr);
        static info::CAniCameradtor_CAniCamera15_clbk CAniCameradtor_CAniCamera15_user(nullptr);
        
        static uint32_t CAniCameraGetCameraIndex1_wrapper(struct CAniCamera* _this, char* arg_0)
        {
           return CAniCameraGetCameraIndex1_user(_this, arg_0, CAniCameraGetCameraIndex1_next);
        };
        static char* CAniCameraGetCameraName2_wrapper(struct CAniCamera* _this, uint32_t arg_0)
        {
           return CAniCameraGetCameraName2_user(_this, arg_0, CAniCameraGetCameraName2_next);
        };
        static uint32_t CAniCameraGetDummyID3_wrapper(struct CAniCamera* _this, char* arg_0, int arg_1)
        {
           return CAniCameraGetDummyID3_user(_this, arg_0, arg_1, CAniCameraGetDummyID3_next);
        };
        static void CAniCameraGetDummyMatrix4_wrapper(struct CAniCamera* _this, float** arg_0, uint32_t arg_1, float arg_2)
        {
           CAniCameraGetDummyMatrix4_user(_this, arg_0, arg_1, arg_2, CAniCameraGetDummyMatrix4_next);
        };
        static void CAniCameraGetDummyMatrixSub5_wrapper(struct CAniCamera* _this, float** arg_0, uint32_t arg_1, float arg_2)
        {
           CAniCameraGetDummyMatrixSub5_user(_this, arg_0, arg_1, arg_2, CAniCameraGetDummyMatrixSub5_next);
        };
        static char* CAniCameraGetDummyParentID6_wrapper(struct CAniCamera* _this, uint32_t arg_0)
        {
           return CAniCameraGetDummyParentID6_user(_this, arg_0, CAniCameraGetDummyParentID6_next);
        };
        static float* CAniCameraGetMatrixAniCamera7_wrapper(struct CAniCamera* _this, float arg_0)
        {
           return CAniCameraGetMatrixAniCamera7_user(_this, arg_0, CAniCameraGetMatrixAniCamera7_next);
        };
        static int64_t CAniCameraIsLoadedAniCamera8_wrapper(struct CAniCamera* _this)
        {
           return CAniCameraIsLoadedAniCamera8_user(_this, CAniCameraIsLoadedAniCamera8_next);
        };
        static void CAniCameraLoadAniCamera9_wrapper(struct CAniCamera* _this, char* Filename)
        {
           CAniCameraLoadAniCamera9_user(_this, Filename, CAniCameraLoadAniCamera9_next);
        };
        static int64_t CAniCameraPlayAniCamera10_wrapper(struct CAniCamera* _this, float** arg_0, float arg_1, int arg_2)
        {
           return CAniCameraPlayAniCamera10_user(_this, arg_0, arg_1, arg_2, CAniCameraPlayAniCamera10_next);
        };
        static void CAniCameraReleaseAniCamera11_wrapper(struct CAniCamera* _this)
        {
           CAniCameraReleaseAniCamera11_user(_this, CAniCameraReleaseAniCamera11_next);
        };
        static int64_t CAniCameraSetExtCamAni12_wrapper(struct CAniCamera* _this)
        {
           return CAniCameraSetExtCamAni12_user(_this, CAniCameraSetExtCamAni12_next);
        };
        static void CAniCameraSetNowFrame13_wrapper(struct CAniCamera* _this, float arg_0)
        {
           CAniCameraSetNowFrame13_user(_this, arg_0, CAniCameraSetNowFrame13_next);
        };
        static void CAniCameraSetPrePlayCamera14_wrapper(struct CAniCamera* _this, uint32_t arg_0, uint32_t arg_1, uint32_t arg_2, uint32_t arg_3)
        {
           CAniCameraSetPrePlayCamera14_user(_this, arg_0, arg_1, arg_2, arg_3, CAniCameraSetPrePlayCamera14_next);
        };
        static int64_t CAniCameradtor_CAniCamera15_wrapper(struct CAniCamera* _this)
        {
           return CAniCameradtor_CAniCamera15_user(_this, CAniCameradtor_CAniCamera15_next);
        };
        
        static hook_record CAniCamera_functions[] = {
        {   (LPVOID)0x14050e600L,
