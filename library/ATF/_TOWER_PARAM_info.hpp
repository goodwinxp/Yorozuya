...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using _TOWER_PARAM___listinit2_ptr = void (WINAPIV*)(struct _TOWER_PARAM::_list*);
        using _TOWER_PARAM___listinit2_clbk = void (WINAPIV*)(struct _TOWER_PARAM::_list*, _TOWER_PARAM___listinit2_ptr);
