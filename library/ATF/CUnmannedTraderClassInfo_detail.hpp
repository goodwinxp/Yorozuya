...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CUnmannedTraderClassInfoctor_CUnmannedTraderClassInfo2_ptr CUnmannedTraderClassInfoctor_CUnmannedTraderClassInfo2_next(nullptr);
        static info::CUnmannedTraderClassInfoctor_CUnmannedTraderClassInfo2_clbk CUnmannedTraderClassInfoctor_CUnmannedTraderClassInfo2_user(nullptr);
        static info::CUnmannedTraderClassInfoCopy4_ptr CUnmannedTraderClassInfoCopy4_next(nullptr);
        static info::CUnmannedTraderClassInfoCopy4_clbk CUnmannedTraderClassInfoCopy4_user(nullptr);
        static info::CUnmannedTraderClassInfoGetID6_ptr CUnmannedTraderClassInfoGetID6_next(nullptr);
        static info::CUnmannedTraderClassInfoGetID6_clbk CUnmannedTraderClassInfoGetID6_user(nullptr);
        static info::CUnmannedTraderClassInfoGetTypeName8_ptr CUnmannedTraderClassInfoGetTypeName8_next(nullptr);
        static info::CUnmannedTraderClassInfoGetTypeName8_clbk CUnmannedTraderClassInfoGetTypeName8_user(nullptr);
        static info::CUnmannedTraderClassInfodtor_CUnmannedTraderClassInfo12_ptr CUnmannedTraderClassInfodtor_CUnmannedTraderClassInfo12_next(nullptr);
        static info::CUnmannedTraderClassInfodtor_CUnmannedTraderClassInfo12_clbk CUnmannedTraderClassInfodtor_CUnmannedTraderClassInfo12_user(nullptr);
        
        static void CUnmannedTraderClassInfoctor_CUnmannedTraderClassInfo2_wrapper(struct CUnmannedTraderClassInfo* _this, unsigned int dwID)
        {
        ...
        static struct CUnmannedTraderClassInfo* CUnmannedTraderClassInfoCopy4_wrapper(struct CUnmannedTraderClassInfo* _this, struct CUnmannedTraderClassInfo* lhs)
        {
           return CUnmannedTraderClassInfoCopy4_user(_this, lhs, CUnmannedTraderClassInfoCopy4_next);
        };
        static unsigned int CUnmannedTraderClassInfoGetID6_wrapper(struct CUnmannedTraderClassInfo* _this)
        {
           return CUnmannedTraderClassInfoGetID6_user(_this, CUnmannedTraderClassInfoGetID6_next);
        };
        static char* CUnmannedTraderClassInfoGetTypeName8_wrapper(struct CUnmannedTraderClassInfo* _this)
        {
           return CUnmannedTraderClassInfoGetTypeName8_user(_this, CUnmannedTraderClassInfoGetTypeName8_next);
        };
        static void CUnmannedTraderClassInfodtor_CUnmannedTraderClassInfo12_wrapper(struct CUnmannedTraderClassInfo* _this)
        {
        ...
        static hook_record CUnmannedTraderClassInfo_functions[] = {
        {   (LPVOID)0x140376f10L,
