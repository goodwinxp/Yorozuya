...
#include "_pt_query_appoint_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_pt_query_appoint_zoclctor__pt_query_appoint_zocl2_ptr _pt_query_appoint_zoclctor__pt_query_appoint_zocl2_next(nullptr);
        static info::_pt_query_appoint_zoclctor__pt_query_appoint_zocl2_clbk _pt_query_appoint_zoclctor__pt_query_appoint_zocl2_user(nullptr);
        static info::_pt_query_appoint_zoclsize4_ptr _pt_query_appoint_zoclsize4_next(nullptr);
        static info::_pt_query_appoint_zoclsize4_clbk _pt_query_appoint_zoclsize4_user(nullptr);
        
        static void _pt_query_appoint_zoclctor__pt_query_appoint_zocl2_wrapper(struct _pt_query_appoint_zocl* _this)
        {
           _pt_query_appoint_zoclctor__pt_query_appoint_zocl2_user(_this, _pt_query_appoint_zoclctor__pt_query_appoint_zocl2_next);
        };
        static int _pt_query_appoint_zoclsize4_wrapper(struct _pt_query_appoint_zocl* _this)
        {
           return _pt_query_appoint_zoclsize4_user(_this, _pt_query_appoint_zoclsize4_next);
        };
        
        static hook_record _pt_query_appoint_zocl_functions[] = {
        {   (LPVOID)0x1402b9c60L,
