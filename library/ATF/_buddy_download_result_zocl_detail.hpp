...
#include "_buddy_download_result_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_buddy_download_result_zoclctor__buddy_download_result_zocl2_ptr _buddy_download_result_zoclctor__buddy_download_result_zocl2_next(nullptr);
        static info::_buddy_download_result_zoclctor__buddy_download_result_zocl2_clbk _buddy_download_result_zoclctor__buddy_download_result_zocl2_user(nullptr);
        static info::_buddy_download_result_zoclsize4_ptr _buddy_download_result_zoclsize4_next(nullptr);
        static info::_buddy_download_result_zoclsize4_clbk _buddy_download_result_zoclsize4_user(nullptr);
        
        static void _buddy_download_result_zoclctor__buddy_download_result_zocl2_wrapper(struct _buddy_download_result_zocl* _this)
        {
        ...
        static int _buddy_download_result_zoclsize4_wrapper(struct _buddy_download_result_zocl* _this)
        {
           return _buddy_download_result_zoclsize4_user(_this, _buddy_download_result_zoclsize4_next);
        };
        
        static hook_record _buddy_download_result_zocl_functions[] = {
        {   (LPVOID)0x1400909e0L,
