...
START_ATF_NAMESPACE
    namespace detail
    {
        ...
        info::_qry_case_all_store_limit_item____listctor___list2_ptr _qry_case_all_store_limit_item____listctor___list2_next(nullptr);
        info::_qry_case_all_store_limit_item____listctor___list2_clbk _qry_case_all_store_limit_item____listctor___list2_user(nullptr);
        info::_qry_case_all_store_limit_item____listinit4_ptr _qry_case_all_store_limit_item____listinit4_next(nullptr);
        info::_qry_case_all_store_limit_item____listinit4_clbk _qry_case_all_store_limit_item____listinit4_user(nullptr);
        ...
        void _qry_case_all_store_limit_item____listctor___list2_wrapper(struct _qry_case_all_store_limit_item::__list* _this)
        {
           _qry_case_all_store_limit_item____listctor___list2_user(_this, _qry_case_all_store_limit_item____listctor___list2_next);
        };
        void _qry_case_all_store_limit_item____listinit4_wrapper(struct _qry_case_all_store_limit_item::__list* _this)
        {
           _qry_case_all_store_limit_item____listinit4_user(_this, _qry_case_all_store_limit_item____listinit4_next);
        };
        
        hook_record _qry_case_all_store_limit_item_functions[] = {
        {   (LPVOID)0x14034bd30L,
