...
#include "_darkhole_member_info_inform_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_darkhole_member_info_inform_zoclctor__darkhole_member_info_inform_zocl2_ptr _darkhole_member_info_inform_zoclctor__darkhole_member_info_inform_zocl2_next(nullptr);
        static info::_darkhole_member_info_inform_zoclctor__darkhole_member_info_inform_zocl2_clbk _darkhole_member_info_inform_zoclctor__darkhole_member_info_inform_zocl2_user(nullptr);
        static info::_darkhole_member_info_inform_zoclsize4_ptr _darkhole_member_info_inform_zoclsize4_next(nullptr);
        static info::_darkhole_member_info_inform_zoclsize4_clbk _darkhole_member_info_inform_zoclsize4_user(nullptr);
        
        static void _darkhole_member_info_inform_zoclctor__darkhole_member_info_inform_zocl2_wrapper(struct _darkhole_member_info_inform_zocl* _this)
        {
        ...
        static int _darkhole_member_info_inform_zoclsize4_wrapper(struct _darkhole_member_info_inform_zocl* _this)
        {
           return _darkhole_member_info_inform_zoclsize4_user(_this, _darkhole_member_info_inform_zoclsize4_next);
        };
        
        static hook_record _darkhole_member_info_inform_zocl_functions[] = {
        {   (LPVOID)0x14026f660L,
