...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_qry_case_unmandtrader_cheat_updateregisttimesize2_ptr _qry_case_unmandtrader_cheat_updateregisttimesize2_next(nullptr);
        static info::_qry_case_unmandtrader_cheat_updateregisttimesize2_clbk _qry_case_unmandtrader_cheat_updateregisttimesize2_user(nullptr);
        
        static int _qry_case_unmandtrader_cheat_updateregisttimesize2_wrapper(struct _qry_case_unmandtrader_cheat_updateregisttime* _this)
        {
        ...
        static hook_record _qry_case_unmandtrader_cheat_updateregisttime_functions[] = {
        {   (LPVOID)0x140360ad0L,
