...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using _STORAGE_LIST___storage_conInit2_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*);
        using _STORAGE_LIST___storage_conInit2_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, _STORAGE_LIST___storage_conInit2_ptr);
        using _STORAGE_LIST___storage_conctor__storage_con4_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, char, uint16_t, unsigned int, unsigned int, uint16_t);
        using _STORAGE_LIST___storage_conctor__storage_con4_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, char, uint16_t, unsigned int, unsigned int, uint16_t, _STORAGE_LIST___storage_conctor__storage_con4_ptr);
        using _STORAGE_LIST___storage_conctor__storage_con6_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*);
        using _STORAGE_LIST___storage_conctor__storage_con6_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, _STORAGE_LIST___storage_conctor__storage_con6_ptr);
        using _STORAGE_LIST___storage_conempty8_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*);
        using _STORAGE_LIST___storage_conempty8_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, _STORAGE_LIST___storage_conempty8_ptr);
        using _STORAGE_LIST___storage_conlock10_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, bool);
        using _STORAGE_LIST___storage_conlock10_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_storage_con*, bool, _STORAGE_LIST___storage_conlock10_ptr);
        
        using _STORAGE_LIST___db_conCalcNewSerialNumber2_ptr = unsigned int (WINAPIV*)();
        using _STORAGE_LIST___db_conCalcNewSerialNumber2_clbk = unsigned int (WINAPIV*)(_STORAGE_LIST___db_conCalcNewSerialNumber2_ptr);
        using _STORAGE_LIST___db_conGetSerialNumber4_ptr = unsigned int (WINAPIV*)(struct _STORAGE_LIST::_db_con*);
        using _STORAGE_LIST___db_conGetSerialNumber4_clbk = unsigned int (WINAPIV*)(struct _STORAGE_LIST::_db_con*, _STORAGE_LIST___db_conGetSerialNumber4_ptr);
        using _STORAGE_LIST___db_conInit6_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*);
        using _STORAGE_LIST___db_conInit6_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*, _STORAGE_LIST___db_conInit6_ptr);
        using _STORAGE_LIST___db_conSetSerialNumber8_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*, unsigned int);
        using _STORAGE_LIST___db_conSetSerialNumber8_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*, unsigned int, _STORAGE_LIST___db_conSetSerialNumber8_ptr);
        using _STORAGE_LIST___db_conctor__db_con10_ptr = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*);
        using _STORAGE_LIST___db_conctor__db_con10_clbk = void (WINAPIV*)(struct _STORAGE_LIST::_db_con*, _STORAGE_LIST___db_conctor__db_con10_ptr);
