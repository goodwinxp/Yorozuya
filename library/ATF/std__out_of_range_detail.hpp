...
#include "std__out_of_range_info.hpp"
    ...
    namespace std
    {
        namespace detail
        {
            ...
            {   (LPVOID)0x140195740L,
                ...
                (LPVOID)cast_pointer_function((void(std::out_of_range::*)(struct std::basic_string<char,std::char_traits<char>,std::allocator<char> >*))&std::out_of_range::ctor_out_of_range) },
            {   (LPVOID)0x140195880L,
