...
#include "_guild_honor_list_result_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_guild_honor_list_result_zoclctor__guild_honor_list_result_zocl2_ptr _guild_honor_list_result_zoclctor__guild_honor_list_result_zocl2_next(nullptr);
        static info::_guild_honor_list_result_zoclctor__guild_honor_list_result_zocl2_clbk _guild_honor_list_result_zoclctor__guild_honor_list_result_zocl2_user(nullptr);
        static info::_guild_honor_list_result_zoclsize4_ptr _guild_honor_list_result_zoclsize4_next(nullptr);
        static info::_guild_honor_list_result_zoclsize4_clbk _guild_honor_list_result_zoclsize4_user(nullptr);
        
        static void _guild_honor_list_result_zoclctor__guild_honor_list_result_zocl2_wrapper(struct _guild_honor_list_result_zocl* _this)
        {
        ...
        static int _guild_honor_list_result_zoclsize4_wrapper(struct _guild_honor_list_result_zocl* _this)
        {
           return _guild_honor_list_result_zoclsize4_user(_this, _guild_honor_list_result_zoclsize4_next);
        };
        
        static hook_record _guild_honor_list_result_zocl_functions[] = {
        {   (LPVOID)0x1402604f0L,
