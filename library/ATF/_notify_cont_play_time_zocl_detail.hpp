...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_notify_cont_play_time_zoclsize2_ptr _notify_cont_play_time_zoclsize2_next(nullptr);
        static info::_notify_cont_play_time_zoclsize2_clbk _notify_cont_play_time_zoclsize2_user(nullptr);
        
        static int _notify_cont_play_time_zoclsize2_wrapper(struct _notify_cont_play_time_zocl* _this)
        {
           return _notify_cont_play_time_zoclsize2_user(_this, _notify_cont_play_time_zoclsize2_next);
        };
        
        static hook_record _notify_cont_play_time_zocl_functions[] = {
        {   (LPVOID)0x1403fea00L,
