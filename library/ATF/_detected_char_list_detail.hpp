...
#include "_detected_char_list_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_detected_char_listAddCharInfo2_ptr _detected_char_listAddCharInfo2_next(nullptr);
        static info::_detected_char_listAddCharInfo2_clbk _detected_char_listAddCharInfo2_user(nullptr);
        static info::_detected_char_listctor__detected_char_list4_ptr _detected_char_listctor__detected_char_list4_next(nullptr);
        static info::_detected_char_listctor__detected_char_list4_clbk _detected_char_listctor__detected_char_list4_user(nullptr);
        static info::_detected_char_listinit6_ptr _detected_char_listinit6_next(nullptr);
        static info::_detected_char_listinit6_clbk _detected_char_listinit6_user(nullptr);
        
        static int _detected_char_listAddCharInfo2_wrapper(struct _detected_char_list* _this, char byCharType, float* fPos)
        {
           return _detected_char_listAddCharInfo2_user(_this, byCharType, fPos, _detected_char_listAddCharInfo2_next);
        };
        static void _detected_char_listctor__detected_char_list4_wrapper(struct _detected_char_list* _this)
        {
           _detected_char_listctor__detected_char_list4_user(_this, _detected_char_listctor__detected_char_list4_next);
        };
        static void _detected_char_listinit6_wrapper(struct _detected_char_list* _this)
        {
           _detected_char_listinit6_user(_this, _detected_char_listinit6_next);
        };
        
        static hook_record _detected_char_list_functions[] = {
        {   (LPVOID)0x1402e5860L,
