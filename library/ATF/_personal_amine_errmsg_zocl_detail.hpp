...
#include "_personal_amine_errmsg_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_personal_amine_errmsg_zoclctor__personal_amine_errmsg_zocl2_ptr _personal_amine_errmsg_zoclctor__personal_amine_errmsg_zocl2_next(nullptr);
        static info::_personal_amine_errmsg_zoclctor__personal_amine_errmsg_zocl2_clbk _personal_amine_errmsg_zoclctor__personal_amine_errmsg_zocl2_user(nullptr);
        static info::_personal_amine_errmsg_zoclsize4_ptr _personal_amine_errmsg_zoclsize4_next(nullptr);
        static info::_personal_amine_errmsg_zoclsize4_clbk _personal_amine_errmsg_zoclsize4_user(nullptr);
        
        static void _personal_amine_errmsg_zoclctor__personal_amine_errmsg_zocl2_wrapper(struct _personal_amine_errmsg_zocl* _this)
        {
        ...
        static int _personal_amine_errmsg_zoclsize4_wrapper(struct _personal_amine_errmsg_zocl* _this)
        {
           return _personal_amine_errmsg_zoclsize4_user(_this, _personal_amine_errmsg_zoclsize4_next);
        };
        
        static hook_record _personal_amine_errmsg_zocl_functions[] = {
        {   (LPVOID)0x1402de350L,
