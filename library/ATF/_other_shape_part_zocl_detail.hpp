...
#include "_other_shape_part_zocl_info.hpp"


START_ATF_NAMESPACE
    namespace detail
    {
        static info::_other_shape_part_zoclctor__other_shape_part_zocl2_ptr _other_shape_part_zoclctor__other_shape_part_zocl2_next(nullptr);
        static info::_other_shape_part_zoclctor__other_shape_part_zocl2_clbk _other_shape_part_zoclctor__other_shape_part_zocl2_user(nullptr);
        static info::_other_shape_part_zoclsize4_ptr _other_shape_part_zoclsize4_next(nullptr);
        static info::_other_shape_part_zoclsize4_clbk _other_shape_part_zoclsize4_user(nullptr);
        
        static void _other_shape_part_zoclctor__other_shape_part_zocl2_wrapper(struct _other_shape_part_zocl* _this)
        {
           _other_shape_part_zoclctor__other_shape_part_zocl2_user(_this, _other_shape_part_zoclctor__other_shape_part_zocl2_next);
        };
        static int _other_shape_part_zoclsize4_wrapper(struct _other_shape_part_zocl* _this)
        {
           return _other_shape_part_zoclsize4_user(_this, _other_shape_part_zoclsize4_next);
        };
        
        static hook_record _other_shape_part_zocl_functions[] = {
        {   (LPVOID)0x140072ba0L,
