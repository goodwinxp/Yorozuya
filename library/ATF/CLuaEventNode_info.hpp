...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CLuaEventNode___Statector__State2_ptr = void (WINAPIV*)(struct CLuaEventNode::_State*);
        using CLuaEventNode___Statector__State2_clbk = void (WINAPIV*)(struct CLuaEventNode::_State*, CLuaEventNode___Statector__State2_ptr);
