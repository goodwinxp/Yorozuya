...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::_throw_unit_result_one_zoclctor__throw_unit_result_one_zocl2_ptr _throw_unit_result_one_zoclctor__throw_unit_result_one_zocl2_next(nullptr);
        static info::_throw_unit_result_one_zoclctor__throw_unit_result_one_zocl2_clbk _throw_unit_result_one_zoclctor__throw_unit_result_one_zocl2_user(nullptr);
        
        static void _throw_unit_result_one_zoclctor__throw_unit_result_one_zocl2_wrapper(struct _throw_unit_result_one_zocl* _this)
        {
        ...
        static hook_record _throw_unit_result_one_zocl_functions[] = {
        {   (LPVOID)0x1400efdb0L,
