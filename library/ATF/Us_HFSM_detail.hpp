...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::Us_HFSMAddLoopDelayTime2_ptr Us_HFSMAddLoopDelayTime2_next(nullptr);
        static info::Us_HFSMAddLoopDelayTime2_clbk Us_HFSMAddLoopDelayTime2_user(nullptr);
        static info::Us_HFSMCleanUp4_ptr Us_HFSMCleanUp4_next(nullptr);
        static info::Us_HFSMCleanUp4_clbk Us_HFSMCleanUp4_user(nullptr);
        static info::Us_HFSMGetIndex6_ptr Us_HFSMGetIndex6_next(nullptr);
        static info::Us_HFSMGetIndex6_clbk Us_HFSMGetIndex6_user(nullptr);
        static info::Us_HFSMGetNode8_ptr Us_HFSMGetNode8_next(nullptr);
        static info::Us_HFSMGetNode8_clbk Us_HFSMGetNode8_user(nullptr);
        static info::Us_HFSMGetObjectA10_ptr Us_HFSMGetObjectA10_next(nullptr);
        static info::Us_HFSMGetObjectA10_clbk Us_HFSMGetObjectA10_user(nullptr);
        static info::Us_HFSMGetState12_ptr Us_HFSMGetState12_next(nullptr);
        static info::Us_HFSMGetState12_clbk Us_HFSMGetState12_user(nullptr);
        static info::Us_HFSMInit14_ptr Us_HFSMInit14_next(nullptr);
        static info::Us_HFSMInit14_clbk Us_HFSMInit14_user(nullptr);
        static info::Us_HFSMLink16_ptr Us_HFSMLink16_next(nullptr);
        static info::Us_HFSMLink16_clbk Us_HFSMLink16_user(nullptr);
        static info::Us_HFSMOnProcess18_ptr Us_HFSMOnProcess18_next(nullptr);
        static info::Us_HFSMOnProcess18_clbk Us_HFSMOnProcess18_user(nullptr);
        static info::Us_HFSMSendExternMsg20_ptr Us_HFSMSendExternMsg20_next(nullptr);
        static info::Us_HFSMSendExternMsg20_clbk Us_HFSMSendExternMsg20_user(nullptr);
        static info::Us_HFSMSendMsg22_ptr Us_HFSMSendMsg22_next(nullptr);
        static info::Us_HFSMSendMsg22_clbk Us_HFSMSendMsg22_user(nullptr);
        static info::Us_HFSMSetLoopTime24_ptr Us_HFSMSetLoopTime24_next(nullptr);
        static info::Us_HFSMSetLoopTime24_clbk Us_HFSMSetLoopTime24_user(nullptr);
        static info::Us_HFSMSetMyData26_ptr Us_HFSMSetMyData26_next(nullptr);
        static info::Us_HFSMSetMyData26_clbk Us_HFSMSetMyData26_user(nullptr);
        static info::Us_HFSMctor_Us_HFSM28_ptr Us_HFSMctor_Us_HFSM28_next(nullptr);
        static info::Us_HFSMctor_Us_HFSM28_clbk Us_HFSMctor_Us_HFSM28_user(nullptr);
        static info::Us_HFSMdtor_Us_HFSM33_ptr Us_HFSMdtor_Us_HFSM33_next(nullptr);
        static info::Us_HFSMdtor_Us_HFSM33_clbk Us_HFSMdtor_Us_HFSM33_user(nullptr);
        
        static void Us_HFSMAddLoopDelayTime2_wrapper(struct Us_HFSM* _this, int nIndex, unsigned int dwAddDelay)
        {
           Us_HFSMAddLoopDelayTime2_user(_this, nIndex, dwAddDelay, Us_HFSMAddLoopDelayTime2_next);
        };
        static void Us_HFSMCleanUp4_wrapper(struct Us_HFSM* _this)
        {
           Us_HFSMCleanUp4_user(_this, Us_HFSMCleanUp4_next);
        };
        static unsigned int Us_HFSMGetIndex6_wrapper(struct Us_HFSM* _this, struct Us_FSM_Node* pNode)
        {
           return Us_HFSMGetIndex6_user(_this, pNode, Us_HFSMGetIndex6_next);
        };
        static struct Us_FSM_Node* Us_HFSMGetNode8_wrapper(struct Us_HFSM* _this, unsigned int dwIndex)
        {
           return Us_HFSMGetNode8_user(_this, dwIndex, Us_HFSMGetNode8_next);
        };
        static void* Us_HFSMGetObjectA10_wrapper(struct Us_HFSM* _this)
        {
           return Us_HFSMGetObjectA10_user(_this, Us_HFSMGetObjectA10_next);
        };
        static unsigned int Us_HFSMGetState12_wrapper(struct Us_HFSM* _this, unsigned int dwIndex)
        {
           return Us_HFSMGetState12_user(_this, dwIndex, Us_HFSMGetState12_next);
        };
        static void Us_HFSMInit14_wrapper(struct Us_HFSM* _this)
        {
           Us_HFSMInit14_user(_this, Us_HFSMInit14_next);
        };
        static int Us_HFSMLink16_wrapper(struct Us_HFSM* _this, struct Us_FSM_Node* pParent, struct Us_FSM_Node* pChild)
        {
           return Us_HFSMLink16_user(_this, pParent, pChild, Us_HFSMLink16_next);
        };
        static void Us_HFSMOnProcess18_wrapper(struct Us_HFSM* _this, unsigned int dwLastTime)
        {
           Us_HFSMOnProcess18_user(_this, dwLastTime, Us_HFSMOnProcess18_next);
        };
        static void Us_HFSMSendExternMsg20_wrapper(struct Us_HFSM* pHFS, unsigned int dwMSG, void* lpParam, int nParam)
        {
           Us_HFSMSendExternMsg20_user(pHFS, dwMSG, lpParam, nParam, Us_HFSMSendExternMsg20_next);
        };
        static void Us_HFSMSendMsg22_wrapper(struct Us_HFSM* pHFS, unsigned int dwFSMIndex, unsigned int dwMSG, void* lpParam)
        {
           Us_HFSMSendMsg22_user(pHFS, dwFSMIndex, dwMSG, lpParam, Us_HFSMSendMsg22_next);
        };
        static void Us_HFSMSetLoopTime24_wrapper(struct Us_HFSM* _this, int nIndex, unsigned int dwLoopTIme)
        {
           Us_HFSMSetLoopTime24_user(_this, nIndex, dwLoopTIme, Us_HFSMSetLoopTime24_next);
        };
        static int Us_HFSMSetMyData26_wrapper(struct Us_HFSM* _this, struct UsStateTBL* pStateTBL, void* pObject)
        {
           return Us_HFSMSetMyData26_user(_this, pStateTBL, pObject, Us_HFSMSetMyData26_next);
        };
        static void Us_HFSMctor_Us_HFSM28_wrapper(struct Us_HFSM* _this)
        {
           Us_HFSMctor_Us_HFSM28_user(_this, Us_HFSMctor_Us_HFSM28_next);
        };
        static void Us_HFSMdtor_Us_HFSM33_wrapper(struct Us_HFSM* _this)
        {
           Us_HFSMdtor_Us_HFSM33_user(_this, Us_HFSMdtor_Us_HFSM33_next);
        };
        
        static hook_record Us_HFSM_functions[] = {
        {   (LPVOID)0x140162b90L,
