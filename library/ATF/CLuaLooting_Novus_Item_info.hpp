...
START_ATF_NAMESPACE
    namespace info
    {
        ...
        using CLuaLooting_Novus_Item___Statector__State2_ptr = void (WINAPIV*)(struct CLuaLooting_Novus_Item::_State*);
        using CLuaLooting_Novus_Item___Statector__State2_clbk = void (WINAPIV*)(struct CLuaLooting_Novus_Item::_State*, CLuaLooting_Novus_Item___Statector__State2_ptr);
