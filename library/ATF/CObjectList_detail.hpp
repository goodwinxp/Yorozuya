...
START_ATF_NAMESPACE
    namespace detail
    {
        static info::CObjectListctor_CObjectList2_ptr CObjectListctor_CObjectList2_next(nullptr);
        static info::CObjectListctor_CObjectList2_clbk CObjectListctor_CObjectList2_user(nullptr);
        static info::CObjectListCopyItem4_ptr CObjectListCopyItem4_next(nullptr);
        static info::CObjectListCopyItem4_clbk CObjectListCopyItem4_user(nullptr);
        static info::CObjectListDeleteItem6_ptr CObjectListDeleteItem6_next(nullptr);
        static info::CObjectListDeleteItem6_clbk CObjectListDeleteItem6_user(nullptr);
        static info::CObjectListGetSize8_ptr CObjectListGetSize8_next(nullptr);
        static info::CObjectListGetSize8_clbk CObjectListGetSize8_user(nullptr);
        static info::CObjectListInitList10_ptr CObjectListInitList10_next(nullptr);
        static info::CObjectListInitList10_clbk CObjectListInitList10_user(nullptr);
        static info::CObjectListPushItem12_ptr CObjectListPushItem12_next(nullptr);
        static info::CObjectListPushItem12_clbk CObjectListPushItem12_user(nullptr);
        static info::CObjectListdtor_CObjectList16_ptr CObjectListdtor_CObjectList16_next(nullptr);
        static info::CObjectListdtor_CObjectList16_clbk CObjectListdtor_CObjectList16_user(nullptr);
        
        static void CObjectListctor_CObjectList2_wrapper(struct CObjectList* _this)
        {
           CObjectListctor_CObjectList2_user(_this, CObjectListctor_CObjectList2_next);
        };
        static struct CGameObject* CObjectListCopyItem4_wrapper(struct CObjectList* _this, unsigned int dwIndex)
        {
           return CObjectListCopyItem4_user(_this, dwIndex, CObjectListCopyItem4_next);
        };
        static bool CObjectListDeleteItem6_wrapper(struct CObjectList* _this, struct _object_list_point* pItem)
        {
           return CObjectListDeleteItem6_user(_this, pItem, CObjectListDeleteItem6_next);
        };
        static int CObjectListGetSize8_wrapper(struct CObjectList* _this)
        {
           return CObjectListGetSize8_user(_this, CObjectListGetSize8_next);
        };
        static void CObjectListInitList10_wrapper(struct CObjectList* _this)
        {
           CObjectListInitList10_user(_this, CObjectListInitList10_next);
        };
        static bool CObjectListPushItem12_wrapper(struct CObjectList* _this, struct _object_list_point* pItem)
        {
           return CObjectListPushItem12_user(_this, pItem, CObjectListPushItem12_next);
        };
        static void CObjectListdtor_CObjectList16_wrapper(struct CObjectList* _this)
        {
           CObjectListdtor_CObjectList16_user(_this, CObjectListdtor_CObjectList16_next);
        };
        
        static hook_record CObjectList_functions[] = {
        {   (LPVOID)0x140188d20L,
